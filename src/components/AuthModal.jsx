    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4" onClick={onClose}>
      ...
      >
        <div className="px-6 pt-8 pb-6 text-center">
          ...
          <h2 className="text-xl font-black text-white mb-1">Acceder a Tuthor</h2>
          <p className="text-white/40 text-sm mb-8">Guarda tu progreso, rachas y puntuaciones</p>
          ...
          <p className="mt-6 text-white/20 text-xs">Al entrar aceptas que tus partidas se guarden en tu cuenta</p>
        </div>
