...
import { DISCLAIMER } from '../data/primerosAuxiliosEscenarios'

// Planteamiento de un escenario de primeros auxilios: icono + texto de la
// emergencia, disclaimer fijo y botón de inicio.
export default function EscenarioSituacion({ escenario, onEmpezar }) {
  const { tr } = useLang()
