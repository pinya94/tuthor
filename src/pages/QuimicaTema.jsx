...
const MODOS_POR_TEMA = {
  ...
  'fuerzas': [
    ...
    },
    {
      ...
      detalles: { es:['10 preguntas','Sin cronómetro','Con el juego','Cálculo explicado'], en:['10 questions','No timer','With the game','Calculation explained'], ca:['10 preguntes','Sense cronòmetre','Amb el joc','Càlcul explicat'] },
