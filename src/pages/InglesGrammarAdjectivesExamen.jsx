...
import { PREGUNTAS_PRIMARIA, PREGUNTAS_ESO } from '../data/inglesGrammarAdjectives'
...
const otroExamen = {
  path: '/examen/ingles-pos-adjectives-test', emoji: '🧐',
...
export default function InglesGrammarAdjectivesExamen() {
  return <ExamenMC titulo={{ es: 'Adjectives', en: 'Adjectives', ca: 'Adjectives' }} emoji="🎨" nivelInfo={nivelInfo} backFallback="/estudiar/idiomas/ingles/grammar" gameId="ingles-grammar-adjectives-test" otroExamen={otroExamen} />
}
