      ...
      <div className="max-w-2xl mx-auto w-full space-y-3">
        {filtrados.length === 0 ? (
          ...
          filtrados.map(tema => (
            <button
              key={tema.id}
              onClick={() => navigate(`/estudiar/historia/${tema.id}`)}
              className="w-full group flex items-center gap-4 bg-white/5 hover:bg-white/10 border border-white/10 hover:border-amber-500/40 rounded-2xl p-5 transition-all text-left"
            >
