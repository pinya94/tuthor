...
const JUEGOS = {
  es: [
    [
      ...
      { slug: 'balanza-algebraica', titulo: 'Balanza Algebraica', desc: 'Resuelve ecuaciones con el método de la balanza: toca un término para restarlo a los dos lados y divide hasta dejar la x sola.', emoji: '🟰', gradient: 'from-violet-600 to-indigo-800', tags: ['Mates','Ecuaciones'] },
    ],
    [
  ...
  en: [
    [
      ...
      { slug: 'balanza-algebraica', titulo: 'Algebra Balance', desc: 'Solve equations with the balance method: tap a term to subtract it from both sides and divide until x stands alone.', emoji: '🟰', gradient: 'from-violet-600 to-indigo-800', tags: ['Maths','Equations'] },
    ],
    [
  ...
  ca: [
    [
      ...
      { slug: 'balanza-algebraica', titulo: 'Balança Algebraica', desc: 'Resol equacions amb el mètode de la balança: toca un terme per restar-lo als dos costats i divideix fins a deixar la x sola.', emoji: '🟰', gradient: 'from-violet-600 to-indigo-800', tags: ['Mates','Equacions'] },
    ],
    [
