...
const DATA = {
  es: {
    ...
    categorias: [
      ...
      {
        titulo: 'Química', emoji: '⚗️',
        texto: 'Tabla periódica, materia, mezclas, ácidos y átomos, con exámenes tipo test adaptados al currículum oficial de Primaria, ESO y Bachillerato.',
        temas: [
      ...
      {
        titulo: 'Física', emoji: '⚡',
        texto: 'Fuerzas y movimiento, energía, electricidad, ondas y luz, con exámenes tipo test por nivel para Primaria y ESO.',
        temas: [
          { nombre: 'Fuerzas y Movimiento', desc: 'Leyes de Newton, velocidad y gravedad.', slug: 'fuerzas' },
          { nombre: 'Energía', desc: 'Tipos, transformaciones y fuentes renovables.', slug: 'energia' },
          { nombre: 'Electricidad', desc: 'Circuitos, corriente y magnitudes eléctricas.', slug: 'electricidad' },
          { nombre: 'Ondas y Luz', desc: 'Sonido, espectro, reflexión y refracción.', slug: 'ondas-luz' },
        ],
      },
      {
        titulo: 'Biología', emoji: '🧬',
        texto: 'La célula, cuerpo humano, seres vivos, ecosistemas, genética y nutrición, adaptadas al currículum de Primaria, ESO y Bachillerato.',
        temas: [
      ...
      },
      {
        ...
        texto: 'Exámenes de gramática y ortografía en español e inglés adaptados al currículum oficial de Primaria y ESO. Cada subtema es un examen independiente de 10 preguntas.',
        temas: [
          { nombre: 'Español — Sustantivos', desc: 'Género, número, tipos y plurales irregulares.', slug: 'espanol-gramatica-sustantivos' },
          { nombre: 'Español — Verbos', desc: 'Conjugación, tiempos verbales, irregulares y modos.', slug: 'espanol-gramatica-verbos' },
          { nombre: 'Español — Sintaxis', desc: 'Sujeto, predicado, CD, CI y oraciones subordinadas.', slug: 'espanol-gramatica-sintaxis' },
          { nombre: 'Español — Acentuación', desc: 'Agudas, llanas, esdrújulas y tilde diacrítica.', slug: 'espanol-ortografia-acentuacion' },
          { nombre: 'Español — B y V', desc: 'Reglas de uso de b y v en español.', slug: 'espanol-ortografia-bv' },
          { nombre: 'English — Present Simple', desc: '3rd person -s, negatives, questions and frequency adverbs.', slug: 'ingles-grammar-present-simple' },
          { nombre: 'English — Past Simple', desc: 'Regular and irregular verbs, did/didn\'t, was/were.', slug: 'ingles-grammar-past-simple' },
  ...
  en: {
    ...
    categorias: [
      ...
      {
        titulo: 'Chemistry', emoji: '⚗️',
        texto: 'Periodic table, matter, mixtures, acids and atoms, with multiple-choice exams aligned to the official Primary, Secondary and Sixth Form syllabus.',
        temas: [
      ...
      {
        titulo: 'Physics', emoji: '⚡',
        texto: 'Forces and motion, energy, electricity, waves and light, with level-based quizzes for Primary and Secondary.',
        temas: [
          { nombre: 'Forces and Motion', desc: 'Newton\'s laws, speed and gravity.', slug: 'fuerzas' },
          { nombre: 'Energy', desc: 'Types, transformations and renewable sources.', slug: 'energia' },
          { nombre: 'Electricity', desc: 'Circuits, current and electrical quantities.', slug: 'electricidad' },
          { nombre: 'Waves and Light', desc: 'Sound, spectrum, reflection and refraction.', slug: 'ondas-luz' },
        ],
      },
      {
        titulo: 'Biology', emoji: '🧬',
        texto: 'The cell, human body, living things, ecosystems, genetics and nutrition, aligned to the Primary, Secondary and Sixth Form curriculum.',
        temas: [
      ...
      },
      {
        ...
        texto: 'Grammar and spelling exams in Spanish and English aligned to the official Primary and Secondary curriculum. Each sub-topic is an independent 10-question exam.',
        temas: [
          { nombre: 'Spanish — Nouns', desc: 'Gender, number, types and irregular plurals.', slug: 'espanol-gramatica-sustantivos' },
          { nombre: 'Spanish — Verbs', desc: 'Conjugation, tenses, irregular verbs and moods.', slug: 'espanol-gramatica-verbos' },
          { nombre: 'Spanish — Syntax', desc: 'Subject, predicate, direct & indirect object, subordinate clauses.', slug: 'espanol-gramatica-sintaxis' },
          { nombre: 'Spanish — Accentuation', desc: 'Stress rules: agudas, llanas, esdrújulas and diacritical accent.', slug: 'espanol-ortografia-acentuacion' },
          { nombre: 'Spanish — B and V', desc: 'Rules for using b and v in Spanish spelling.', slug: 'espanol-ortografia-bv' },
          { nombre: 'English — Present Simple', desc: '3rd person -s, negatives, questions and frequency adverbs.', slug: 'ingles-grammar-present-simple' },
          { nombre: 'English — Past Simple', desc: 'Regular and irregular verbs, did/didn\'t, was/were.', slug: 'ingles-grammar-past-simple' },
          { nombre: 'English — Present Perfect', desc: 'Have/has + past participle, for/since, just/already/yet.', slug: 'ingles-grammar-present-perfect' },
          { nombre: 'English — Articles', desc: 'A, an, the and zero article: rules and exceptions.', slug: 'ingles-grammar-articles' },
  ...
  ca: {
    ...
    categorias: [
      ...
      {
        titulo: 'Química', emoji: '⚗️',
        texto: 'Taula periòdica, matèria, mescles, àcids i àtoms, amb exàmens tipus test adaptats al currículum oficial de Primària, ESO i Batxillerat.',
        temas: [
      ...
      {
        titulo: 'Física', emoji: '⚡',
        texto: 'Forces i moviment, energia, electricitat, ones i llum, amb exàmens tipus test per nivell per a Primària i ESO.',
        temas: [
          { nombre: 'Forces i Moviment', desc: 'Lleis de Newton, velocitat i gravetat.', slug: 'fuerzas' },
      ...
      {
        titulo: 'Biologia', emoji: '🧬',
        texto: 'La cèl·lula, cos humà, éssers vius, ecosistemes, genètica i nutrició, adaptades al currículum de Primària, ESO i Batxillerat.',
        temas: [
      ...
      },
      {
        ...
        texto: 'Exàmens de gramàtica i ortografia en espanyol i anglès adaptats al currículum oficial de Primària i ESO. Cada subtema és un examen independent de 10 preguntes.',
        temas: [
          { nombre: 'Espanyol — Substantius', desc: 'Gènere, nombre, tipus i plurals irregulars.', slug: 'espanol-gramatica-sustantivos' },
          { nombre: 'Espanyol — Verbs', desc: 'Conjugació, temps verbals, irregulars i modes.', slug: 'espanol-gramatica-verbos' },
          { nombre: 'Espanyol — Sintaxi', desc: 'Subjecte, predicat, CD, CI i oracions subordinades.', slug: 'espanol-gramatica-sintaxis' },
          { nombre: 'Espanyol — Accentuació', desc: 'Regles d\'accentuació: agudes, planes, esdrúixoles i accent diacrític.', slug: 'espanol-ortografia-acentuacion' },
          { nombre: 'Espanyol — B i V', desc: 'Regles d\'ús de b i v en ortografia castellana.', slug: 'espanol-ortografia-bv' },
          { nombre: 'English — Present Simple', desc: '3rd person -s, negatives, questions and frequency adverbs.', slug: 'ingles-grammar-present-simple' },
          { nombre: 'English — Past Simple', desc: 'Regular and irregular verbs, did/didn\'t, was/were.', slug: 'ingles-grammar-past-simple' },
          { nombre: 'English — Present Perfect', desc: 'Have/has + past participle, for/since, just/already/yet.', slug: 'ingles-grammar-present-perfect' },
          { nombre: 'English — Articles', desc: 'A, an, the and zero article: rules and exceptions.', slug: 'ingles-grammar-articles' },
