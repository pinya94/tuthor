...
// calculándola.
//
// La generación de rondas vive en lib/saltaRectaEngine.js — la comparte el
// examen (SaltaRectaExamen.jsx) para que "saltar +4" signifique lo mismo en
// los dos sitios.

const DIFS = Object.fromEntries(Object.entries(RANGOS).map(([id, r]) => [id, {
  ...r,
  time: id === 'facil' ? 75 : id === 'medio' ? 70 : 60,
  bonus: id === 'facil' ? 5 : 4,
}]))
