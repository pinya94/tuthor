...
const TablasMultiplicar  = lazy(() => import('./pages/TablasMultiplicar'))
...
const RecursoFracciones  = lazy(() => import('./pages/RecursoFracciones'))
...
const TareaExamen        = lazy(() => import('./pages/TareaExamen'))
...
function AppRoutes() {
  return (
    <>
      ...
      <Route path="juegos/tablas-multiplicar" element={<TablasMultiplicar />} />
      ...
      <Route path="recursos/fracciones" element={<RecursoFracciones />} />
      <Route path="recursos/fracciones/:tipo" element={<RecursoFracciones />} />
      ...
      <Route path="clase/examen/:taskId" element={<TareaExamen />} />
    </>
  )
}
