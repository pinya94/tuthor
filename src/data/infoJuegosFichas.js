...
export const FICHAS_ES = {
  'lee-el-grafico': {
    ...
    enPapel: {
      ...
      pasos: [
        'Recorta un gráfico de un periódico o imprime uno del INE (población de tu provincia, paro por trimestres).',
        'Antes de leer el texto que lo acompaña, responde por escrito: ¿sube o baja?, ¿cuál es el máximo?, ¿en qué tramo cambia más deprisa?',
        'Comprueba SIEMPRE el eje vertical: ¿empieza en cero? Si no, vuelve a mirar la gráfica sabiéndolo y comprueba si tu primera impresión cambia.',
        'Compara tu lectura con lo que dice el titular. No siempre coinciden, y ahí está la lección.',
      ],
    },
    alternativas: [
      { nombre: 'Estadístico Exprés', desc: 'Si lo que quieres es calcular media, mediana, moda y rango en vez de interpretar la forma.' },
      { nombre: 'El examen de Geografía Humana', desc: 'Pirámides de población y tasas, con los mismos conceptos aplicados a datos reales.' },
    ],
  },
  'genetica': {
    titulo: 'Genética',
  ...
  'el-cambio': {
    titulo: 'El Cambio',
    subtitulo: 'Juego de Contar Euros, Monedas y Billetes y Dar el Cambio',
    emoji: '💶', gradient: 'from-emerald-500 to-green-700', path: '/juegos/el-cambio',
    examPath: '/examen/el-cambio-test',
    intro: 'Un juego de matemáticas para manejar el dinero de verdad: se pide una cantidad y hay que formarla tocando monedas y billetes de euro, que se van sumando en la bandeja hasta cuadrar. En el nivel difícil ya no se forma una cantidad, sino que se da el cambio de un billete: algo cuesta X, pagas con Y, ¿cuánto hay que devolver? Al fallar se ve la cantidad correcta, así que cada intento enseña.',
    beneficios: [
      { titulo: 'El valor de cada moneda, no un número abstracto', texto: 'Para llegar a 3,70 € el alumno tiene que combinar 2 €, 1 €, 50 c y 20 c y ver cómo suman. Manipular las piezas asienta el valor de cada una mucho mejor que una ficha de sumas.' },
      { titulo: 'Sumar con decimales sin darse cuenta', texto: 'Contar dinero es sumar céntimos y euros —números con dos decimales— pero con un objetivo concreto y ganas de cuadrar. Es la puerta natural a los decimales, con sentido.' },
      { titulo: 'Dar el cambio: una resta con utilidad', texto: 'Devolver el cambio de un billete es una resta que todo el mundo hace en la vida real. Practicarla con las monedas delante conecta las mates con la tienda, el mercado o la máquina.' },
    ],
    ejemplo: 'Pide formar 3,70 €. El alumno toca un billete de… no hay: pone 2 € + 1 € (van 3 €), luego 50 c (3,50) y 20 c (3,70). La bandeja marca 3,70 € en verde y confirma. En difícil: cuesta 6,80 €, paga con 10 € → tiene que formar 3,20 € de cambio.',
    enPapel: {
      titulo: 'El dinero en papel',
      pasos: [
        'Reúne monedas y billetes de verdad (o recórtalos de cartulina): 5c, 10c, 20c, 50c, 1 €, 2 €, 5 €, 10 €…',
        'Di una cantidad y que el alumno la forme con las piezas de varias maneras distintas.',
        'Monta una tienda: pon precios, paga con un billete y que devuelva el cambio contando hacia arriba.',
        'Comprueba siempre sumando en voz alta las piezas de la bandeja.',
      ],
    },
    alternativas: [
      { nombre: 'La tienda en casa', desc: 'Precios a objetos de casa, una caja con monedas y turnos de comprar y cobrar: el mejor simulador del dinero, y encima gratis.' },
      { nombre: 'El examen del dinero', desc: 'La misma mecánica sin reloj de partida y con nota final, para repasar formar cantidades y dar el cambio con calma.' },
      { nombre: 'La hucha', desc: 'Contar de vez en cuando lo que hay en la hucha —agrupando por monedas iguales y sumando— es práctica de dinero con recompensa real.' },
    ],
    asignatura: 'Matemáticas', niveles: 'Primaria',
  },
  'numeros-romanos': {
  ...
  'escalera-unidades': {
    titulo: 'La Escalera de Unidades',
    subtitulo: 'Juego de Conversión de Unidades del Sistema Métrico',
    emoji: '🔟', gradient: 'from-cyan-500 to-blue-700', path: '/juegos/escalera-unidades',
    examPath: '/examen/escalera-unidades-test',
    intro: 'Un juego de matemáticas para convertir unidades sin perderse: se pide pasar una cantidad de una unidad a otra (3 km a metros, 250 cm a metros, 1,5 kg a gramos…) y hay que escribir el resultado. La clave es la escalera del sistema métrico —km, hm, dam, m, dm, cm, mm—: cada escalón hacia abajo multiplica por 10 y cada escalón hacia arriba divide por 10. El juego dibuja la escalera y marca los dos escalones, así que se ve cuántos saltos hay y en qué sentido.',
    beneficios: [
      { titulo: 'La regla del ×10 y ÷10, hecha imagen', texto: 'En lugar de memorizar factores sueltos, el alumno cuenta escalones sobre la escalera dibujada: bajar multiplica, subir divide. Ver los saltos evita el error clásico de mover la coma al revés.' },
      { titulo: 'Longitud, masa y capacidad, la misma mecánica', texto: 'km/m/cm, kg/g/mg y L/mL comparten exactamente la misma escalera. Practicar las tres con el mismo gesto deja claro que el sistema métrico es uno solo, no tres reglas distintas.' },
      { titulo: 'Se teclea en pantalla, no molesta el móvil', texto: 'El resultado se escribe con un teclado numérico propio con coma decimal: nada de que el teclado del teléfono tape media pantalla. Cómodo para practicar en el sofá.' },
    ],
    ejemplo: 'Pide pasar 2,5 m a cm. En la escalera, de m a cm hay dos escalones hacia abajo: ×100. El alumno teclea 250 y confirma. Si fallara, el juego muestra 2,5 m = 250 cm con la escalera resaltada.',
    enPapel: {
      titulo: 'La escalera en papel',
      pasos: [
        'Dibuja la escalera y escribe las unidades: km, hm, dam, m, dm, cm, mm.',
        'Marca de qué unidad partes y a cuál vas, y cuenta los escalones.',
        'Hacia abajo multiplica por 10 por cada escalón; hacia arriba divide por 10.',
        'Repite con masa (kg…mg) y capacidad (kL…mL): es la misma escalera.',
      ],
    },
    alternativas: [
      { nombre: 'Medir de verdad', desc: 'Medir objetos con una regla y pasar de cm a mm o a m, o pesar en la cocina y pasar de g a kg, ancla las conversiones en algo tangible.' },
      { nombre: 'El examen de conversión de unidades', desc: 'La misma escalera sin reloj de partida y con nota final, para repasar longitud, masa y capacidad con calma.' },
      { nombre: 'Recetas y distancias', desc: 'Convertir los gramos de una receta a kilos, o los kilómetros de un trayecto a metros, convierte el ejercicio en algo con uso diario.' },
    ],
    asignatura: 'Matemáticas', niveles: 'Primaria, ESO',
  },
  'redondeo': {
    titulo: 'Redondeo',
    subtitulo: 'Juego de Redondear a la Decena, Centena y Millar',
    emoji: '📍', gradient: 'from-violet-500 to-purple-700', path: '/juegos/redondeo',
    examPath: '/examen/redondeo-test',
    intro: 'Un juego de matemáticas para redondear entendiendo qué significa: el número aparece sobre una recta, entre sus dos "redondos" vecinos (por ejemplo 3847 entre 3800 y 3900), y hay que tocar el más cercano. Como se ve la posición sobre la recta, redondear deja de ser una regla memorizada y se convierte en algo que se entiende: ¿a cuál está más cerca? Se practica a la decena, la centena, el millar y también con decimales.',
    beneficios: [
      { titulo: 'Redondear como distancia, no como truco', texto: 'Ver el número entre sus dos redondos vecinos deja claro qué se está haciendo: buscar el más cercano. Esa imagen mental es la que evita el error de redondear al azar o hacia el lado que no toca.' },
      { titulo: 'La regla del 5, con sentido', texto: 'La marca del medio de la recta es justo la frontera del 5: por encima se sube, por debajo se baja. El alumno descubre por qué el 5 redondea hacia arriba en lugar de aprendérselo de memoria.' },
      { titulo: 'Un solo gesto, todos los órdenes', texto: 'Decena, centena, millar y decimales usan exactamente la misma mecánica. Redondear 3847 a la centena o 3,47 a la décima es el mismo problema, y practicarlos juntos lo deja claro.' },
    ],
    ejemplo: 'Pide redondear 3847 a la centena. En la recta, el 3847 aparece entre 3800 y 3900, más cerca del 3800. El alumno toca 3800. Si dudara, la posición sobre la recta —y la marca del medio en 3850— le dan la respuesta.',
    enPapel: {
      titulo: 'El redondeo en papel',
      pasos: [
        'Localiza la cifra del orden al que redondeas (la decena, la centena…).',
        'Mira la cifra siguiente: es la que decide.',
        'Si es 5 o más, sube una unidad esa cifra; si es menos, déjala igual.',
        'Pon ceros en todas las cifras que quedan a la derecha.',
      ],
    },
    alternativas: [
      { nombre: 'Estimar en la compra', desc: 'Redondear los precios al euro para calcular el total aproximado de la compra es la aplicación más natural del redondeo en el día a día.' },
      { nombre: 'El examen de redondeo', desc: 'La misma recta sin reloj de partida y con nota final, para repasar con calma los distintos órdenes.' },
      { nombre: 'La recta numérica', desc: 'Colocar números sobre una recta dibujada y marcar entre qué decenas o centenas caen refuerza la idea de cercanía que hay detrás del redondeo.' },
    ],
    asignatura: 'Matemáticas', niveles: 'Primaria, ESO',
  },
  'tablas-multiplicar': {
  ...
  'cambio-estado': {
    ...
    intro: 'Un juego de química para romper de una vez la idea de que sólido es frío y gas es caliente. Te dan una sustancia y una temperatura, y tienes que decir en qué estado está. Hay tres niveles. En los dos primeros los puntos de fusión y ebullición están a la vista y no hay nada que memorizar: solo saber leer dónde cae esa temperatura respecto a los dos puntos de ESA sustancia. En el difícil se tapan, así que hay que conocer la sustancia, y aparecen al corregir. Son 30 sustancias reales, de metales a gases, y al responder ves las partículas de ese estado: ordenadas y quietas en el sólido, sueltas en el líquido, disparadas en el gas.',
    beneficios: [
      ...
      { titulo: 'Leer una escala, no memorizarla', texto: 'En los dos primeros niveles los puntos de fusión y ebullición están en pantalla a propósito. La habilidad que se entrena es situar un valor entre dos umbrales, que es la misma que hace falta para leer una gráfica, un termómetro o una tabla de datos en cualquier asignatura.' },
      { titulo: 'Una sola cosa, muchas veces', texto: 'El juego hace una única pregunta y la repite con 30 sustancias distintas. Esa insistencia es la que convierte la regla en un automatismo, en vez de dispersar la atención entre varias mecánicas en la misma partida. Y como la temperatura se sortea en cada ronda, la misma sustancia nunca pregunta dos veces lo mismo: no se puede aprender la respuesta de memoria.' },
    ],
    ...
    enPapel: {
      titulo: 'Los estados en papel',
      pasos: [
        'Dibuja una recta con los dos puntos de una sustancia marcados y sus tres zonas.',
        'Ve cantando temperaturas al azar y que se señale la zona antes de decir el estado.',
        'Repite con una sustancia rara (mercurio, oxígeno) y compara las dos rectas.',
        'Al final, escribe los seis cambios de estado con un ejemplo de casa para cada uno.',
      ],
    },
    alternativas: [
      { nombre: 'El vaso con hielo', desc: 'Poned un vaso con hielo y observad las tres cosas a la vez: el hielo que se funde, el agua líquida y el vaho que se condensa por fuera. Tres cambios de estado en un solo vaso.' },
      { nombre: 'La tabla de puntos', desc: 'Buscad los puntos de fusión y ebullición de diez sustancias y ordenadlas. Ver el helio a −269 y el hierro a 1538 en la misma tabla dice más que cualquier explicación.' },
      { nombre: 'Caza cambios de estado en casa', desc: 'Durante un día, apuntad cada cambio de estado que veáis: la ropa que se seca, el espejo empañado, un helado derritiéndose. Nombrarlos en el momento es lo que fija el vocabulario.' },
    ],
    asignatura: 'Química', niveles: 'Primaria, ESO, Bachillerato',
  },
  'corrige-el-texto': {
...
export const FICHAS_EN = {
  'lee-el-grafico': {
    ...
    enPapel: {
      ...
      pasos: [
        'Cut a chart out of a newspaper or print one from a statistics office.',
        'Before reading the accompanying text, answer in writing: up or down? where is the peak? which stretch changes fastest?',
        'ALWAYS check the vertical axis: does it start at zero? If not, look again knowing that and see whether your first impression changes.',
        'Compare your reading with the headline. They do not always agree, and that is the lesson.',
      ],
    },
    alternativas: [
      { nombre: 'Quick Statistician', desc: 'If you want to calculate mean, median, mode and range rather than interpret shape.' },
      { nombre: 'The Human Geography quiz', desc: 'Population pyramids and rates, the same ideas applied to real data.' },
    ],
  },
  'genetica': {
    titulo: 'Genetics',
  ...
  'el-cambio': {
    titulo: 'The Change',
    subtitulo: 'Game to Count Euros, Coins and Notes and Give Change',
    emoji: '💶', gradient: 'from-emerald-500 to-green-700', path: '/juegos/el-cambio',
    examPath: '/examen/el-cambio-test',
    intro: 'A maths game to handle real money: an amount is asked and you make it by tapping euro coins and notes, which add up in the tray until it matches. On the hard level you no longer make an amount but give change from a note: something costs X, you pay with Y, how much do you give back? On a miss the correct amount shows, so every try teaches.',
    beneficios: [
      { titulo: 'The value of each coin, not an abstract number', texto: 'To reach €3.70 the student has to combine €2, €1, 50c and 20c and see how they add up. Handling the pieces settles each one\'s value far better than a sums worksheet.' },
      { titulo: 'Adding decimals without noticing', texto: 'Counting money is adding cents and euros —numbers with two decimals— but with a concrete goal and the urge to match it. It is the natural door to decimals, with meaning.' },
      { titulo: 'Giving change: a subtraction with a purpose', texto: 'Giving change from a note is a subtraction everyone does in real life. Practising it with the coins in front connects maths to the shop, the market or the machine.' },
    ],
    ejemplo: 'It asks to make €3.70. The student puts €2 + €1 (that\'s €3), then 50c (€3.50) and 20c (€3.70). The tray shows €3.70 in green and they confirm. On hard: it costs €6.80, you pay with €10 → you must make €3.20 in change.',
    enPapel: {
      titulo: 'Money on paper',
      pasos: [
        'Gather real coins and notes (or cut them from card): 5c, 10c, 20c, 50c, €1, €2, €5, €10…',
        'Say an amount and have the student make it with the pieces in several different ways.',
        'Set up a shop: put prices, pay with a note and have them give change by counting up.',
        'Always check by adding the pieces in the tray out loud.',
      ],
    },
    alternativas: [
      { nombre: 'The shop at home', desc: 'Prices on household objects, a box of coins and turns to buy and charge: the best money simulator, and free.' },
      { nombre: 'The money exam', desc: 'The same mechanic without the game clock and with a final grade, to revise making amounts and giving change calmly.' },
  ...
  'escalera-unidades': {
    titulo: 'The Unit Staircase',
    subtitulo: 'A Game for Converting Metric Units',
    emoji: '🔟', gradient: 'from-cyan-500 to-blue-700', path: '/juegos/escalera-unidades',
    examPath: '/examen/escalera-unidades-test',
    intro: 'A maths game to convert units without getting lost: you are asked to turn a quantity from one unit into another (3 km into metres, 250 cm into metres, 1.5 kg into grams…) and you type the result. The key is the metric staircase —km, hm, dam, m, dm, cm, mm—: each step down multiplies by 10 and each step up divides by 10. The game draws the staircase and marks the two steps, so you can see how many jumps there are and in which direction.',
    beneficios: [
      { titulo: 'The ×10 and ÷10 rule, turned into a picture', texto: 'Instead of memorising loose factors, the pupil counts steps on the drawn staircase: down multiplies, up divides. Seeing the jumps prevents the classic mistake of moving the decimal point the wrong way.' },
      { titulo: 'Length, mass and capacity, one mechanic', texto: 'km/m/cm, kg/g/mg and L/mL share exactly the same staircase. Practising all three with the same gesture makes it clear the metric system is one thing, not three different rules.' },
      { titulo: 'Typed on screen, no phone keyboard in the way', texto: 'The result is entered with a built-in numeric keypad with a decimal point: no phone keyboard covering half the screen. Comfortable for practising on the sofa.' },
    ],
    ejemplo: 'It asks you to turn 2.5 m into cm. On the staircase, m to cm is two steps down: ×100. The pupil types 250 and confirms. If they got it wrong, the game shows 2.5 m = 250 cm with the staircase highlighted.',
    enPapel: {
      titulo: 'The staircase on paper',
      pasos: [
        'Draw the staircase and write the units: km, hm, dam, m, dm, cm, mm.',
        'Mark which unit you start from and which you go to, and count the steps.',
        'Down, multiply by 10 per step; up, divide by 10 per step.',
        'Repeat with mass (kg…mg) and capacity (kL…mL): it is the same staircase.',
      ],
    },
    alternativas: [
      { nombre: 'Measure for real', desc: 'Measuring objects with a ruler and going from cm to mm or to m, or weighing in the kitchen and going from g to kg, anchors conversions in something tangible.' },
      { nombre: 'The unit-conversion exam', desc: 'The same staircase with no game clock and a final mark, to review length, mass and capacity calmly.' },
      { nombre: 'Recipes and distances', desc: 'Converting a recipe’s grams into kilos, or a trip’s kilometres into metres, turns the exercise into something with daily use.' },
    ],
    asignatura: 'Mathematics', niveles: 'Primary, Secondary',
  },
  'redondeo': {
    titulo: 'Rounding',
    subtitulo: 'A Game for Rounding to the Nearest Ten, Hundred and Thousand',
    emoji: '📍', gradient: 'from-violet-500 to-purple-700', path: '/juegos/redondeo',
    examPath: '/examen/redondeo-test',
    intro: 'A maths game to round while understanding what it means: the number appears on a number line, between its two round neighbours (for example 3847 between 3800 and 3900), and you tap the nearer one. Because you can see the position on the line, rounding stops being a memorised rule and becomes something you understand: which one is it closer to? You practise to the nearest ten, hundred, thousand and also with decimals.',
    beneficios: [
      { titulo: 'Rounding as distance, not a trick', texto: 'Seeing the number between its two round neighbours makes clear what you are doing: finding the nearest one. That mental picture is what prevents rounding at random or the wrong way.' },
      { titulo: 'The rule of 5, with meaning', texto: 'The midpoint mark on the line is exactly the boundary of the 5: above it you round up, below it you round down. The pupil discovers why 5 rounds up instead of just memorising it.' },
      { titulo: 'One gesture, every place', texto: 'Ten, hundred, thousand and decimals use exactly the same mechanic. Rounding 3847 to the hundred or 3.47 to the tenth is the same problem, and practising them together makes that clear.' },
    ],
    ejemplo: 'It asks you to round 3847 to the nearest hundred. On the line, 3847 sits between 3800 and 3900, closer to 3800. The pupil taps 3800. If they hesitate, the position on the line —and the midpoint mark at 3850— give the answer.',
    enPapel: {
      titulo: 'Rounding on paper',
      pasos: [
        'Find the digit of the place you are rounding to (the ten, the hundred…).',
        'Look at the next digit: that is the one that decides.',
        'If it is 5 or more, add one to that digit; if less, leave it as it is.',
        'Put zeros in all the digits to its right.',
      ],
    },
    alternativas: [
      { nombre: 'Estimating while shopping', desc: 'Rounding prices to the euro to work out the approximate total of the shopping is the most natural everyday use of rounding.' },
      { nombre: 'The rounding exam', desc: 'The same line with no game clock and a final mark, to review the different places calmly.' },
  ...
  'cambio-estado': {
    ...
    intro: 'A chemistry game to finally break the idea that solid means cold and gas means hot. You get a substance and a temperature, and you say what state it is in. There are three levels. On the first two the melting and boiling points are on screen and there is nothing to memorise: you just read where that temperature falls relative to the two points of THAT substance. On hard they are hidden, so you have to know the substance, and they appear when the answer is revealed. There are 30 real substances, from metals to gases, and on answering you see the particles for that state: ordered and still in a solid, loose in a liquid, flying in a gas.',
    beneficios: [
      ...
      { titulo: 'Reading a scale, not memorising it', texto: 'On the first two levels the melting and boiling points are on screen on purpose. The skill trained is placing a value between two thresholds — the same one needed to read a graph, a thermometer or a data table in any subject.' },
      { titulo: 'One thing, many times', texto: 'The game asks a single question and repeats it across 30 different substances. That insistence is what turns the rule into an automatism, instead of splitting attention between several mechanics in one session. And since the temperature is drawn at random each round, the same substance never asks the same thing twice: the answer cannot be learnt by heart.' },
    ],
    ...
    enPapel: {
      titulo: 'States on paper',
      pasos: [
        'Draw a line with a substance\'s two points marked and its three zones.',
        'Call out random temperatures and have the zone pointed at before the state is named.',
        'Repeat with an odd substance (mercury, oxygen) and compare the two lines.',
        'Finally, write the six changes of state with a household example for each.',
      ],
    },
    alternativas: [
      { nombre: 'The glass of ice', desc: 'Put ice in a glass and watch three things at once: ice melting, liquid water, and mist condensing outside. Three changes of state in one glass.' },
      { nombre: 'The table of points', desc: 'Look up melting and boiling points for ten substances and order them. Seeing helium at −269 and iron at 1538 in one table says more than any explanation.' },
  ...
  'corrige-el-texto': {
    ...
    beneficios: [
      ...
      { titulo: 'Homophones, where it really bites', texto: 'The hard level brings in correctly spelled words placed where they do not belong: there for their, than for then, quiet for quite. The letters give nothing away and only the whole sentence says which one belongs. That is the jump from knowing spelling to understanding what you read.' },
    ],
    ejemplo: 'The text says: "When we finaly arrived, our teacher said we had to stay together." It reads without a stumble, which is exactly the problem: finally keeps the double l, because it is final plus -ly. A student who lets it through picks up a ten-second penalty and, in the review, the rule alongside it.',
    enPapel: {
    ...
    asignatura: 'Languages', niveles: 'Primary, Secondary',
  },
  'pon-la-tilde': {
...
export const FICHAS_CA = {
  'lee-el-grafico': {
    titulo: 'Llegeix el Gràfic',
    subtitulo: 'Interpreta Dades de Població, Vendes i Clima',
    emoji: '📉', gradient: 'from-cyan-500 to-teal-700', path: '/juegos/lee-el-grafico',
    ...
    enPapel: {
      ...
      pasos: [
        "Retalla un gràfic d'un diari o imprimeix-ne un de l'Idescat o l'INE.",
        "Abans de llegir el text que l'acompanya, respon per escrit: puja o baixa?, quin és el màxim?, en quin tram canvia més de pressa?",
        "Comprova SEMPRE l'eix vertical: comença a zero? Si no, torna a mirar el gràfic sabent-ho i comprova si la teva primera impressió canvia.",
        'Compara la teva lectura amb el que diu el titular. No sempre coincideixen, i aquí hi ha la lliçó.',
      ],
    },
    alternativas: [
      { nombre: 'Estadístic Exprés', desc: "Si el que vols és calcular mitjana, mediana, moda i rang en comptes d'interpretar la forma." },
      { nombre: "L'examen de Geografia Humana", desc: 'Piràmides de població i taxes, amb els mateixos conceptes aplicats a dades reals.' },
    ],
  },
  'genetica': {
    titulo: 'Genètica',
  ...
  'el-cambio': {
    titulo: 'El Canvi',
    subtitulo: 'Joc de Comptar Euros, Monedes i Bitllets i Donar el Canvi',
    emoji: '💶', gradient: 'from-emerald-500 to-green-700', path: '/juegos/el-cambio',
    examPath: '/examen/el-cambio-test',
    intro: 'Un joc de matemàtiques per manejar els diners de veritat: es demana una quantitat i cal formar-la tocant monedes i bitllets d\'euro, que se sumen a la safata fins a quadrar. Al nivell difícil ja no es forma una quantitat, sinó que es dona el canvi d\'un bitllet: una cosa costa X, pagues amb Y, quant has de tornar? En fallar es veu la quantitat correcta, així que cada intent ensenya.',
    beneficios: [
      { titulo: 'El valor de cada moneda, no un número abstracte', texto: 'Per arribar a 3,70 € l\'alumne ha de combinar 2 €, 1 €, 50 c i 20 c i veure com sumen. Manipular les peces assenta el valor de cadascuna molt millor que una fitxa de sumes.' },
      { titulo: 'Sumar amb decimals sense adonar-se\'n', texto: 'Comptar diners és sumar cèntims i euros —números amb dos decimals— però amb un objectiu concret i ganes de quadrar. És la porta natural als decimals, amb sentit.' },
      { titulo: 'Donar el canvi: una resta amb utilitat', texto: 'Tornar el canvi d\'un bitllet és una resta que tothom fa a la vida real. Practicar-la amb les monedes al davant connecta les mates amb la botiga, el mercat o la màquina.' },
    ],
    ejemplo: 'Demana formar 3,70 €. L\'alumne posa 2 € + 1 € (van 3 €), després 50 c (3,50) i 20 c (3,70). La safata marca 3,70 € en verd i confirma. En difícil: costa 6,80 €, paga amb 10 € → ha de formar 3,20 € de canvi.',
    enPapel: {
      titulo: 'Els diners en paper',
      pasos: [
        'Reuneix monedes i bitllets de veritat (o retalla\'ls de cartolina): 5c, 10c, 20c, 50c, 1 €, 2 €, 5 €, 10 €…',
        'Digues una quantitat i que l\'alumne la formi amb les peces de diverses maneres.',
        'Munta una botiga: posa preus, paga amb un bitllet i que torni el canvi comptant cap amunt.',
        'Comprova sempre sumant en veu alta les peces de la safata.',
      ],
    },
    alternativas: [
      { nombre: 'La botiga a casa', desc: 'Preus a objectes de casa, una caixa amb monedes i torns de comprar i cobrar: el millor simulador dels diners, i a sobre gratis.' },
      { nombre: 'L\'examen dels diners', desc: 'La mateixa mecànica sense rellotge de partida i amb nota final, per repassar formar quantitats i donar el canvi amb calma.' },
  ...
  'escalera-unidades': {
    titulo: 'L\'Escala d\'Unitats',
    subtitulo: 'Joc de Conversió d\'Unitats del Sistema Mètric',
    emoji: '🔟', gradient: 'from-cyan-500 to-blue-700', path: '/juegos/escalera-unidades',
    examPath: '/examen/escalera-unidades-test',
    intro: 'Un joc de matemàtiques per convertir unitats sense perdre\'s: es demana passar una quantitat d\'una unitat a una altra (3 km a metres, 250 cm a metres, 1,5 kg a grams…) i cal escriure el resultat. La clau és l\'escala del sistema mètric —km, hm, dam, m, dm, cm, mm—: cada esglaó cap avall multiplica per 10 i cada esglaó cap amunt divideix per 10. El joc dibuixa l\'escala i marca els dos esglaons, així que es veu quants salts hi ha i en quin sentit.',
    beneficios: [
      { titulo: 'La regla del ×10 i ÷10, feta imatge', texto: 'En lloc de memoritzar factors solts, l\'alumne compta esglaons sobre l\'escala dibuixada: baixar multiplica, pujar divideix. Veure els salts evita l\'error clàssic de moure la coma al revés.' },
      { titulo: 'Longitud, massa i capacitat, la mateixa mecànica', texto: 'km/m/cm, kg/g/mg i L/mL comparteixen exactament la mateixa escala. Practicar-les totes tres amb el mateix gest deixa clar que el sistema mètric és un de sol, no tres regles diferents.' },
      { titulo: 'Es tecleja a la pantalla, el mòbil no molesta', texto: 'El resultat s\'escriu amb un teclat numèric propi amb coma decimal: res de teclat del telèfon que tapi mitja pantalla. Còmode per practicar al sofà.' },
    ],
    ejemplo: 'Demana passar 2,5 m a cm. A l\'escala, de m a cm hi ha dos esglaons cap avall: ×100. L\'alumne tecleja 250 i confirma. Si fallés, el joc mostra 2,5 m = 250 cm amb l\'escala resaltada.',
    enPapel: {
      titulo: 'L\'escala en paper',
      pasos: [
        'Dibuixa l\'escala i escriu les unitats: km, hm, dam, m, dm, cm, mm.',
        'Marca de quina unitat parteixes i a quina vas, i compta els esglaons.',
        'Cap avall multiplica per 10 per cada esglaó; cap amunt divideix per 10.',
        'Repeteix amb massa (kg…mg) i capacitat (kL…mL): és la mateixa escala.',
      ],
    },
    alternativas: [
      { nombre: 'Mesurar de debò', desc: 'Mesurar objectes amb un regle i passar de cm a mm o a m, o pesar a la cuina i passar de g a kg, ancora les conversions en alguna cosa tangible.' },
      { nombre: 'L\'examen de conversió d\'unitats', desc: 'La mateixa escala sense rellotge de partida i amb nota final, per repassar longitud, massa i capacitat amb calma.' },
      { nombre: 'Receptes i distàncies', desc: 'Convertir els grams d\'una recepta a quilos, o els quilòmetres d\'un trajecte a metres, converteix l\'exercici en alguna cosa amb ús diari.' },
    ],
    asignatura: 'Matemàtiques', niveles: 'Primària, ESO',
  },
  'redondeo': {
    titulo: 'Arrodoniment',
    subtitulo: 'Joc d\'Arrodonir a la Desena, Centena i Miler',
    emoji: '📍', gradient: 'from-violet-500 to-purple-700', path: '/juegos/redondeo',
    examPath: '/examen/redondeo-test',
    intro: 'Un joc de matemàtiques per arrodonir entenent què significa: el nombre apareix sobre una recta, entre els seus dos "redons" veïns (per exemple 3847 entre 3800 i 3900), i cal tocar el més proper. Com que es veu la posició sobre la recta, arrodonir deixa de ser una regla memoritzada i es converteix en alguna cosa que s\'entén: a quin està més a prop? Es practica a la desena, la centena, el miler i també amb decimals.',
    beneficios: [
      { titulo: 'Arrodonir com a distància, no com a truc', texto: 'Veure el nombre entre els seus dos redons veïns deixa clar què s\'està fent: buscar el més proper. Aquesta imatge mental és la que evita l\'error d\'arrodonir a l\'atzar o cap al costat que no toca.' },
      { titulo: 'La regla del 5, amb sentit', texto: 'La marca del mig de la recta és just la frontera del 5: per damunt es puja, per sota es baixa. L\'alumne descobreix per què el 5 arrodoneix cap amunt en lloc d\'aprendre-s\'ho de memòria.' },
      { titulo: 'Un sol gest, tots els ordres', texto: 'Desena, centena, miler i decimals fan servir exactament la mateixa mecànica. Arrodonir 3847 a la centena o 3,47 a la dècima és el mateix problema, i practicar-los junts ho deixa clar.' },
    ],
    ejemplo: 'Demana arrodonir 3847 a la centena. A la recta, el 3847 apareix entre 3800 i 3900, més a prop del 3800. L\'alumne toca 3800. Si dubtés, la posició sobre la recta —i la marca del mig al 3850— li donen la resposta.',
    enPapel: {
      titulo: 'L\'arrodoniment en paper',
      pasos: [
        'Localitza la xifra de l\'ordre al qual arrodoneixes (la desena, la centena…).',
        'Mira la xifra següent: és la que decideix.',
        'Si és 5 o més, suma una unitat a aquesta xifra; si és menys, deixa-la igual.',
        'Posa zeros a totes les xifres que queden a la dreta.',
      ],
    },
    alternativas: [
      { nombre: 'Estimar a la compra', desc: 'Arrodonir els preus a l\'euro per calcular el total aproximat de la compra és l\'aplicació més natural de l\'arrodoniment en el dia a dia.' },
      { nombre: 'L\'examen d\'arrodoniment', desc: 'La mateixa recta sense rellotge de partida i amb nota final, per repassar amb calma els diferents ordres.' },
  ...
  'cambio-estado': {
    ...
    emoji: '🌡️', gradient: 'from-sky-600 to-blue-800', path: '/juegos/cambio-estado',
    intro: 'Un joc de química per trencar d\'una vegada la idea que sòlid és fred i gas és calent. Et donen una substància i una temperatura, i has de dir en quin estat és. Hi ha tres nivells. Als dos primers els punts de fusió i ebullició són a la vista i no hi ha res per memoritzar: només cal saber llegir on cau aquesta temperatura respecte als dos punts d\'AQUESTA substància. Són 30 substàncies reals, de metalls a gasos, i en respondre veus les partícules d\'aquest estat: ordenades i quietes al sòlid, soltes al líquid, disparades al gas.',
    beneficios: [
      ...
      { titulo: 'Llegir una escala, no memoritzar-la', texto: 'Als dos primers nivells els punts són a la pantalla a propòsit; al difícil es tapen i surten en corregir. L\'habilitat que s\'entrena és situar un valor entre dos llindars, la mateixa que cal per llegir una gràfica o un termòmetre.' },
      { titulo: 'Una sola cosa, moltes vegades', texto: 'El joc fa una única pregunta i la repeteix amb 30 substàncies diferents. I com que la temperatura se sorteja a cada ronda, la mateixa substància no pregunta mai el mateix dos cops. Aquesta insistència és la que converteix la regla en un automatisme, en comptes de dispersar l\'atenció entre diverses mecàniques en la mateixa partida.' },
    ],
    ...
    enPapel: {
      titulo: 'Els estats en paper',
      pasos: [
        'Dibuixa una recta amb els dos punts d\'una substància marcats i les seves tres zones.',
        'Ves cantant temperatures a l\'atzar i que s\'assenyali la zona abans de dir l\'estat.',
        'Repeteix amb una substància rara (mercuri, oxigen) i compara les dues rectes.',
        'Al final, escriu els sis canvis d\'estat amb un exemple de casa per a cadascun.',
      ],
    },
    alternativas: [
      { nombre: 'El got amb gel', desc: 'Poseu un got amb gel i observeu tres coses alhora: el gel que es fon, l\'aigua líquida i el baf que es condensa per fora.' },
      { nombre: 'La taula de punts', desc: 'Busqueu els punts de fusió i ebullició de deu substàncies i ordeneu-les. Veure l\'heli a −269 i el ferro a 1538 a la mateixa taula diu més que qualsevol explicació.' },
  ...
  'corrige-el-texto': {
    ...
    emoji: '🔍', gradient: 'from-amber-500 to-orange-700', path: '/juegos/corrige-el-texto',
    intro: "Un joc d'ortografia que no avisa. Surt un text d'unes vuitanta paraules amb diverses faltes amagades a dins —en català, castellà o anglès, cada llengua amb les seves—, es diu quantes n'hi ha i res més: ni on són ni de quin tipus. Cal llegir-lo sencer decidint paraula per paraula si aquella està ben posada, que és exactament el que fa qualsevol repassant un examen abans de lliurar-lo. Són tres textos per partida i només compta el temps, però cada falta que s'escapa suma deu segons, i cada paraula correcta que es marca per si de cas, deu més.",
    beneficios: [
      ...
      { titulo: 'Els homòfons, on de veritat costa', texto: "Al nivell difícil entren paraules ben escrites posades on no van: es per és, mes per més, te per té. La lletra no delata res i només la frase sencera diu quina toca. És el salt de saber ortografia a entendre el que es llegeix." },
    ],
    ejemplo: "El text diu que vam haver d'esperar mitja hora a la porta del collegi. La paraula es llegeix sense entrebancar-se, que és justament el problema: col·legi porta ela geminada, i qui la deixa passar s'emporta deu segons de penalització i, en corregir, la regla al costat.",
    enPapel: {
