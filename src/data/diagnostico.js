    ...
    rondas: [
      {
        respuesta: 'estomago',
        pistas: [
          { es: 'Formo parte del sistema digestivo.', en: "I'm part of the digestive system.", ca: 'Formo part del sistema digestiu.' },
    ...
    rondas: [
      {
        respuesta: 'cerebro',
        pistas: [
          { es: 'Formo parte del sistema nervioso o de los sentidos.', en: "I'm part of the nervous system or the senses.", ca: 'Formo part del sistema nerviós o dels sentits.' },
    ...
    rondas: [
      {
        respuesta: 'granito',
        pistas: [
          { es: 'Soy una roca o un mineral que puedes encontrar en la corteza terrestre.', en: "I'm a rock or a mineral you can find in the Earth's crust.", ca: "Soc una roca o un mineral que pots trobar a l'escorça terrestre." },
    ...
    rondas: [
      {
        respuesta: 'solido',
        pistas: [
          { es: 'Soy un concepto relacionado con los estados de la materia.', en: "I'm a concept related to the states of matter.", ca: 'Soc un concepte relacionat amb els estats de la matèria.' },
    ...
    rondas: [
      {
        respuesta: 'oxigeno',
        pistas: [
          { es: 'Soy un elemento químico de la tabla periódica.', en: "I'm a chemical element in the periodic table.", ca: 'Soc un element químic de la taula periòdica.' },
