...
export const EVENTOS = [
  ...
  // ══ ADULTO (25-64) ═══════════════════════════════════════════════════════
  {
    ...
    opciones: [
      ...
      {
        id: 'capricho',
        texto: { es: 'Un viaje que nunca olvidarás', en: 'A trip you\'ll never forget', ca: 'Un viatge que mai oblidaràs' },
        aplicar: (p, ctx) => {
          ctx.dinero(-Math.round(ctx.cant('ahorro') * 0.8))
          return { nota: { es: 'Dinero convertido en recuerdos. No todo en la vida es acumular — pero que sea una elección, no una costumbre.', en: 'Money turned into memories. Life isn\'t all about hoarding — but make it a choice, not a habit.', ca: 'Diners convertits en records. No tot a la vida és acumular — però que sigui una elecció, no un costum.' } }
        },
      },
    ],
  },
