...
export const TASKS = {
  ...
  verbo:       { min: 0, cat: 'clases', label: { es: 'los verbos', en: 'the verbs', ca: 'els verbs' },
    explica: { es: 'El verbo expresa la acción o el estado. Es el núcleo del predicado; una oración compuesta tiene varios.', en: 'The verb expresses the action or state; a compound sentence has several.', ca: 'El verb expressa l’acció o l’estat; una oració composta en té diversos.' } },
