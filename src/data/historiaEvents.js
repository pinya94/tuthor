...
export const EVENTOS_HISTORIA = [
  ...
  // ── EDAD ANTIGUA: MESOPOTAMIA, EGIPTO Y GRECIA ───────────────────────────
  // Roma tiene su propio bloque justo arriba — aquí solo el resto de la
  // Antigüedad, para no duplicar eventos entre los dos temas.
  { id: 'ant_01', nombre: "Invención de la escritura", nombreEn: "Invention of writing", nombreCa: "Invenció de l'escriptura", año: -3000, descripcion: "Los sumerios crean la escritura cuneiforme en Mesopotamia. Empieza la Historia.", descripcionEn: "The Sumerians create cuneiform writing in Mesopotamia. History begins.", descripcionCa: "Els sumeris creen l'escriptura cuneïforme a Mesopotàmia. Comença la Història.", dificultad: "fácil", categoria: "antigua", nivel: ['primaria'] },
  { id: 'ant_02', nombre: "Unificación del Antiguo Egipto", nombreEn: "Unification of Ancient Egypt", nombreCa: "Unificació de l'Antic Egipte", año: -3100, descripcion: "El faraón Menes une el Alto y el Bajo Egipto bajo una sola corona.", descripcionEn: "Pharaoh Menes unites Upper and Lower Egypt under one crown.", descripcionCa: "El faraó Menes uneix l'Alt i el Baix Egipte sota una sola corona.", dificultad: "difícil", categoria: "antigua", nivel: ['eso','bachillerato'] },
  { id: 'ant_03', nombre: "Construcción de la Gran Pirámide de Guiza", nombreEn: "Construction of the Great Pyramid of Giza", nombreCa: "Construcció de la Gran Piràmide de Giza", año: -2560, descripcion: "Se termina la mayor tumba jamás construida para un faraón, Keops.", descripcionEn: "The largest tomb ever built for a pharaoh, Khufu, is completed.", descripcionCa: "S'acaba la tomba més gran mai construïda per a un faraó, Kheops.", dificultad: "fácil", categoria: "antigua", nivel: ['primaria'] },
  { id: 'ant_04', nombre: "Código de Hammurabi", nombreEn: "Code of Hammurabi", nombreCa: "Codi d'Hammurabi", año: -1750, descripcion: "El rey de Babilonia graba en piedra uno de los primeros códigos de leyes de la historia.", descripcionEn: "The king of Babylon carves into stone one of history's first legal codes.", descripcionCa: "El rei de Babilònia grava en pedra un dels primers codis de lleis de la història.", dificultad: "difícil", categoria: "antigua", nivel: ['bachillerato'] },
  { id: 'ant_05', nombre: "Reinado de Tutankamón", nombreEn: "Reign of Tutankhamun", nombreCa: "Regnat de Tutankamon", año: -1332, descripcion: "Sube al trono un faraón niño que reinará poco, pero se hará famoso 3000 años después.", descripcionEn: "A child pharaoh takes the throne — he will reign briefly, but become famous 3,000 years later.", descripcionCa: "Puja al tron un faraó nen que regnarà poc, però es farà famós 3000 anys després.", dificultad: "medio", categoria: "antigua", nivel: ['primaria','eso','bachillerato'] },
  { id: 'ant_06', nombre: "Reforma de Solón en Atenas", nombreEn: "Solon's Reforms in Athens", nombreCa: "Reforma de Soló a Atenes", año: -594, descripcion: "Solón reduce el poder de la aristocracia ateniense, sentando las bases de la democracia.", descripcionEn: "Solon curbs the power of the Athenian aristocracy, laying the groundwork for democracy.", descripcionCa: "Soló redueix el poder de l'aristocràcia atenesa, posant les bases de la democràcia.", dificultad: "difícil", categoria: "antigua", nivel: ['bachillerato'] },
  { id: 'ant_07', nombre: "Primeros Juegos Olímpicos", nombreEn: "First Olympic Games", nombreCa: "Primers Jocs Olímpics", año: -776, descripcion: "En Olimpia se celebra la primera competición olímpica de la historia.", descripcionEn: "The first Olympic competition in history is held at Olympia.", descripcionCa: "A Olímpia se celebra la primera competició olímpica de la història.", dificultad: "fácil", categoria: "antigua", nivel: ['primaria'] },
  { id: 'ant_08', nombre: "Nace la democracia en Atenas", nombreEn: "Democracy is Born in Athens", nombreCa: "Neix la democràcia a Atenes", año: -508, descripcion: "Las reformas de Clístenes dan a los ciudadanos atenienses el voto directo sobre las leyes.", descripcionEn: "Cleisthenes's reforms give Athenian citizens a direct vote on laws.", descripcionCa: "Les reformes de Clístenes donen als ciutadans atenesos el vot directe sobre les lleis.", dificultad: "medio", categoria: "antigua", nivel: ['eso','bachillerato'] },
  { id: 'ant_09', nombre: "Batalla de Maratón", nombreEn: "Battle of Marathon", nombreCa: "Batalla de Marató", año: -490, descripcion: "Atenas derrota al Imperio persa, invasor muy superior en número.", descripcionEn: "Athens defeats the Persian Empire, a vastly larger invading force.", descripcionCa: "Atenes derrota l'Imperi persa, invasor molt superior en nombre.", dificultad: "medio", categoria: "antigua", nivel: ['eso','bachillerato'] },
  { id: 'ant_10', nombre: "Fundación de la Liga de Delos", nombreEn: "Founding of the Delian League", nombreCa: "Fundació de la Lliga de Delos", año: -478, descripcion: "Atenas lidera una alianza de ciudades griegas contra Persia, germen de su imperio marítimo.", descripcionEn: "Athens leads an alliance of Greek cities against Persia, the seed of its maritime empire.", descripcionCa: "Atenes lidera una aliança de ciutats gregues contra Pèrsia, germen del seu imperi marítim.", dificultad: "difícil", categoria: "antigua", nivel: ['bachillerato'] },
  { id: 'ant_11', nombre: "Guerra del Peloponeso", nombreEn: "Peloponnesian War", nombreCa: "Guerra del Peloponès", año: -431, descripcion: "Atenas y Esparta se enfrentan durante 27 años por el dominio de Grecia.", descripcionEn: "Athens and Sparta fight for 27 years over control of Greece.", descripcionCa: "Atenes i Esparta s'enfronten durant 27 anys pel domini de Grècia.", dificultad: "medio", categoria: "antigua", nivel: ['eso','bachillerato'] },
  { id: 'ant_12', nombre: "Imperio de Alejandro Magno", nombreEn: "Empire of Alexander the Great", nombreCa: "Imperi d'Alexandre Magne", año: -336, descripcion: "Alejandro Magno hereda el trono de Macedonia y empieza a conquistar medio mundo conocido.", descripcionEn: "Alexander the Great inherits the throne of Macedon and begins conquering half the known world.", descripcionCa: "Alexandre Magne hereta el tron de Macedònia i comença a conquerir mig món conegut.", dificultad: "fácil", categoria: "antigua", nivel: ['primaria','eso','bachillerato'] },
  { id: 'ant_13', nombre: "Decreto de la Piedra de Rosetta", nombreEn: "Decree of the Rosetta Stone", nombreCa: "Decret de la Pedra de Rosetta", año: -196, descripcion: "Sacerdotes egipcios graban un decreto en tres escrituras — la clave que descifraría los jeroglíficos siglos después.", descripcionEn: "Egyptian priests carve a decree in three scripts — the key that would decipher hieroglyphics centuries later.", descripcionCa: "Sacerdots egipcis graven un decret en tres escriptures — la clau que desxifraria els jeroglífics segles després.", dificultad: "difícil", categoria: "antigua", nivel: ['bachillerato'] },
  { id: 'ant_14', nombre: "Muerte de Cleopatra", nombreEn: "Death of Cleopatra", nombreCa: "Mort de Cleòpatra", año: -30, descripcion: "Muere la última faraona de Egipto. El país pasa a manos romanas.", descripcionEn: "The last pharaoh of Egypt dies. The country falls under Roman rule.", descripcionCa: "Mor l'última faraona d'Egipte. El país passa a mans romanes.", dificultad: "medio", categoria: "antigua", nivel: ['eso','bachillerato'] },
  ...
  // ── FRANQUISMO ────────────────────────────────────────────────────────────
  { id: 'fran_01', nombre: "Franco instaura la dictadura", nombreEn: "Franco establishes the dictatorship", nombreCa: "Franco instaura la dictadura", año: 1939, descripcion: "Acabada la Guerra Civil, Franco concentra todo el poder como Jefe del Estado.", descripcionEn: "With the Civil War over, Franco concentrates all power as Head of State.", descripcionCa: "Acabada la Guerra Civil, Franco concentra tot el poder com a Cap de l'Estat.", dificultad: "fácil", categoria: "franquismo", nivel: ['eso','bachillerato'] },
  { id: 'fran_02', nombre: "Ley de Sucesión", nombreEn: "Law of Succession", nombreCa: "Llei de Successió", año: 1947, descripcion: "Un referéndum define España como reino, con Franco como regente vitalicio.", descripcionEn: "A referendum defines Spain as a kingdom, with Franco as regent for life.", descripcionCa: "Un referèndum defineix Espanya com a regne, amb Franco com a regent vitalici.", dificultad: "difícil", categoria: "franquismo", nivel: ['bachillerato'] },
  { id: 'fran_03', nombre: "Pactos de Madrid con Estados Unidos", nombreEn: "Madrid Pacts with the United States", nombreCa: "Pactes de Madrid amb els Estats Units", año: 1953, descripcion: "EEUU instala bases militares en España a cambio de ayuda económica. Franco sale del aislamiento internacional.", descripcionEn: "The US sets up military bases in Spain in exchange for economic aid. Franco breaks out of international isolation.", descripcionCa: "Els EUA instal·len bases militars a Espanya a canvi d'ajuda econòmica. Franco surt de l'aïllament internacional.", dificultad: "medio", categoria: "franquismo", nivel: ['eso','bachillerato'] },
  { id: 'fran_04', nombre: "España ingresa en la ONU", nombreEn: "Spain joins the United Nations", nombreCa: "Espanya ingressa a l'ONU", año: 1955, descripcion: "Tras años de veto, España es admitida en la Organización de Naciones Unidas.", descripcionEn: "After years of being vetoed, Spain is admitted to the United Nations.", descripcionCa: "Després d'anys de veto, Espanya és admesa a l'Organització de les Nacions Unides.", dificultad: "medio", categoria: "franquismo", nivel: ['eso','bachillerato'] },
  { id: 'fran_05', nombre: "Lanzamiento del Seat 600", nombreEn: "Launch of the Seat 600", nombreCa: "Llançament del Seat 600", año: 1957, descripcion: "El primer coche asequible llega a los hogares españoles. Símbolo del 'desarrollismo'.", descripcionEn: "The first affordable car reaches Spanish households. A symbol of the era's rapid economic growth.", descripcionCa: "El primer cotxe assequible arriba a les llars espanyoles. Símbol del 'desarrollisme'.", dificultad: "fácil", categoria: "franquismo", nivel: ['eso','bachillerato'] },
  { id: 'fran_06', nombre: "Fundación de ETA", nombreEn: "Founding of ETA", nombreCa: "Fundació d'ETA", año: 1959, descripcion: "Nace la organización terrorista independentista vasca.", descripcionEn: "The Basque separatist terrorist organisation is founded.", descripcionCa: "Neix l'organització terrorista independentista basca.", dificultad: "medio", categoria: "franquismo", nivel: ['bachillerato'] },
  { id: 'fran_07', nombre: "Plan de Estabilización", nombreEn: "Stabilization Plan", nombreCa: "Pla d'Estabilització", año: 1959, descripcion: "Tecnócratas del Opus Dei abren la economía española al exterior. Arranca el 'milagro español'.", descripcionEn: "Opus Dei technocrats open the Spanish economy to the outside world. The 'Spanish miracle' begins.", descripcionCa: "Tecnòcrates de l'Opus Dei obren l'economia espanyola a l'exterior. Arrenca el 'miracle espanyol'.", dificultad: "difícil", categoria: "franquismo", nivel: ['bachillerato'] },
  { id: 'fran_08', nombre: "Ley Orgánica del Estado", nombreEn: "Organic Law of the State", nombreCa: "Llei Orgànica de l'Estat", año: 1966, descripcion: "Un referéndum aprueba la ley que completa el marco institucional del régimen.", descripcionEn: "A referendum approves the law that completes the regime's institutional framework.", descripcionCa: "Un referèndum aprova la llei que completa el marc institucional del règim.", dificultad: "difícil", categoria: "franquismo", nivel: ['bachillerato'] },
  { id: 'fran_09', nombre: "Juan Carlos, nombrado sucesor", nombreEn: "Juan Carlos named successor", nombreCa: "Joan Carles, nomenat successor", año: 1969, descripcion: "Franco designa a Juan Carlos de Borbón como futuro Rey de España.", descripcionEn: "Franco designates Juan Carlos de Borbón as the future King of Spain.", descripcionCa: "Franco designa Joan Carles de Borbó com a futur Rei d'Espanya.", dificultad: "medio", categoria: "franquismo", nivel: ['bachillerato'] },
  { id: 'fran_10', nombre: "Asesinato de Carrero Blanco", nombreEn: "Assassination of Carrero Blanco", nombreCa: "Assassinat de Carrero Blanco", año: 1973, descripcion: "ETA mata al presidente del Gobierno con una bomba en Madrid.", descripcionEn: "ETA kills the Prime Minister with a bomb in Madrid.", descripcionCa: "ETA mata el president del Govern amb una bomba a Madrid.", dificultad: "medio", categoria: "franquismo", nivel: ['bachillerato'] },
  { id: 'fran_11', nombre: "Muerte de Franco", nombreEn: "Death of Franco", nombreCa: "Mort de Franco", año: 1975, descripcion: "El dictador muere tras 36 años en el poder. Empieza la Transición a la democracia.", descripcionEn: "The dictator dies after 36 years in power. The Transition to democracy begins.", descripcionCa: "El dictador mor després de 36 anys en el poder. Comença la Transició a la democràcia.", dificultad: "fácil", categoria: "franquismo", nivel: ['eso','bachillerato'] },

  // ── PREHISTORIA ───────────────────────────────────────────────────────────
  // Fechas de hace miles/millones de años: aproximadas por naturaleza, como
  // en cualquier libro de texto — no pretenden precisión al año.
  { id: 'preh_01', nombre: "Aparición de los primeros homínidos", nombreEn: "First hominins appear", nombreCa: "Aparició dels primers homínids", año: -2500000, descripcion: "Los primeros miembros del género Homo aparecen en África.", descripcionEn: "The first members of the genus Homo appear in Africa.", descripcionCa: "Els primers membres del gènere Homo apareixen a l'Àfrica.", dificultad: "difícil", categoria: "prehistoria", nivel: ['bachillerato'] },
  { id: 'preh_02', nombre: "Control del fuego", nombreEn: "Control of fire", nombreCa: "Control del foc", año: -800000, descripcion: "Los primeros humanos aprenden a controlar y usar el fuego.", descripcionEn: "Early humans learn to control and use fire.", descripcionCa: "Els primers humans aprenen a controlar i usar el foc.", dificultad: "medio", categoria: "prehistoria", nivel: ['eso','bachillerato'] },
  { id: 'preh_03', nombre: "Aparición del Homo sapiens", nombreEn: "Homo sapiens appears", nombreCa: "Aparició de l'Homo sapiens", año: -300000, descripcion: "Nuestra especie aparece en África y empieza a extenderse por el mundo.", descripcionEn: "Our species appears in Africa and begins to spread across the world.", descripcionCa: "La nostra espècie apareix a l'Àfrica i comença a estendre's pel món.", dificultad: "medio", categoria: "prehistoria", nivel: ['eso','bachillerato'] },
  { id: 'preh_04', nombre: "Pinturas rupestres de Altamira", nombreEn: "Cave paintings of Altamira", nombreCa: "Pintures rupestres d'Altamira", año: -14000, descripcion: "Los humanos del Paleolítico pintan bisontes y ciervos en una cueva cántabra.", descripcionEn: "Palaeolithic humans paint bison and deer in a cave in Cantabria.", descripcionCa: "Els humans del Paleolític pinten bisons i cérvols en una cova cantàbrica.", dificultad: "fácil", categoria: "prehistoria", nivel: ['primaria','eso','bachillerato'] },
  { id: 'preh_05', nombre: "Comienza la agricultura (Revolución Neolítica)", nombreEn: "Farming begins (Neolithic Revolution)", nombreCa: "Comença l'agricultura (Revolució Neolítica)", año: -10000, descripcion: "Los humanos dejan de ser nómadas y empiezan a cultivar la tierra.", descripcionEn: "Humans stop being nomadic and start cultivating the land.", descripcionCa: "Els humans deixen de ser nòmades i comencen a conrear la terra.", dificultad: "fácil", categoria: "prehistoria", nivel: ['primaria','eso','bachillerato'] },
  { id: 'preh_06', nombre: "Domesticación de animales", nombreEn: "Domestication of animals", nombreCa: "Domesticació d'animals", año: -9000, descripcion: "Ovejas, cabras y vacas empiezan a criarse junto a los primeros poblados.", descripcionEn: "Sheep, goats and cattle begin to be raised alongside the first settlements.", descripcionCa: "Ovelles, cabres i vaques comencen a criar-se al costat dels primers poblats.", dificultad: "medio", categoria: "prehistoria", nivel: ['eso','bachillerato'] },
  { id: 'preh_07', nombre: "Comienza la Edad del Cobre", nombreEn: "The Copper Age begins", nombreCa: "Comença l'Edat del Coure", año: -5000, descripcion: "Los humanos aprenden a fundir y trabajar el cobre, el primer metal.", descripcionEn: "Humans learn to smelt and work copper, the first metal.", descripcionCa: "Els humans aprenen a fondre i treballar el coure, el primer metall.", dificultad: "difícil", categoria: "prehistoria", nivel: ['bachillerato'] },
  { id: 'preh_08', nombre: "Invención de la rueda", nombreEn: "Invention of the wheel", nombreCa: "Invenció de la roda", año: -3500, descripcion: "Una de las invenciones más importantes de la historia humana.", descripcionEn: "One of the most important inventions in human history.", descripcionCa: "Una de les invencions més importants de la història humana.", dificultad: "fácil", categoria: "prehistoria", nivel: ['primaria','eso','bachillerato'] },
  { id: 'preh_09', nombre: "Comienza la Edad del Bronce", nombreEn: "The Bronze Age begins", nombreCa: "Comença l'Edat del Bronze", año: -3300, descripcion: "La aleación de cobre y estaño da herramientas y armas más resistentes.", descripcionEn: "The alloy of copper and tin produces tougher tools and weapons.", descripcionCa: "L'aliatge de coure i estany dona eines i armes més resistents.", dificultad: "difícil", categoria: "prehistoria", nivel: ['bachillerato'] },
  { id: 'preh_10', nombre: "Construcción de Stonehenge", nombreEn: "Construction of Stonehenge", nombreCa: "Construcció de Stonehenge", año: -3000, descripcion: "El famoso monumento megalítico se levanta en Inglaterra.", descripcionEn: "The famous megalithic monument is built in England.", descripcionCa: "El famós monument megalític s'aixeca a Anglaterra.", dificultad: "medio", categoria: "prehistoria", nivel: ['eso','bachillerato'] },
  { id: 'preh_11', nombre: "Comienza la Edad del Hierro", nombreEn: "The Iron Age begins", nombreCa: "Comença l'Edat del Ferro", año: -1200, descripcion: "El hierro, más duro y abundante que el bronce, cambia herramientas y armas.", descripcionEn: "Iron, harder and more abundant than bronze, transforms tools and weapons.", descripcionCa: "El ferro, més dur i abundant que el bronze, canvia eines i armes.", dificultad: "difícil", categoria: "prehistoria", nivel: ['bachillerato'] },

  // ── EDAD MEDIA ────────────────────────────────────────────────────────────
  { id: 'medi_01', nombre: "Caída del Imperio Romano de Occidente", nombreEn: "Fall of the Western Roman Empire", nombreCa: "Caiguda de l'Imperi Romà d'Occident", año: 476, descripcion: "Los pueblos germánicos acaban con el Imperio Romano. Empieza la Edad Media.", descripcionEn: "Germanic peoples bring down the Roman Empire. The Middle Ages begin.", descripcionCa: "Els pobles germànics acaben amb l'Imperi Romà. Comença l'Edat Mitjana.", dificultad: "fácil", categoria: "edad-media", nivel: ['primaria','eso','bachillerato'] },
  { id: 'medi_02', nombre: "Invasión árabe de la Península Ibérica", nombreEn: "Moorish invasion of the Iberian Peninsula", nombreCa: "Invasió àrab de la Península Ibèrica", año: 711, descripcion: "Los musulmanes cruzan el Estrecho de Gibraltar y conquistan casi toda Hispania.", descripcionEn: "Muslim forces cross the Strait of Gibraltar and conquer most of Hispania.", descripcionCa: "Els musulmans creuen l'Estret de Gibraltar i conquesten gairebé tota Hispània.", dificultad: "medio", categoria: "edad-media", nivel: ['eso','bachillerato'] },
  { id: 'medi_03', nombre: "Batalla de Covadonga", nombreEn: "Battle of Covadonga", nombreCa: "Batalla de Covadonga", año: 722, descripcion: "Don Pelayo vence a un destacamento musulmán. Tradicionalmente, el inicio de la Reconquista.", descripcionEn: "Don Pelayo defeats a Muslim detachment. Traditionally seen as the start of the Reconquista.", descripcionCa: "Don Pelayo venç un destacament musulmà. Tradicionalment, l'inici de la Reconquesta.", dificultad: "difícil", categoria: "edad-media", nivel: ['bachillerato'] },
  { id: 'medi_04', nombre: "Coronación de Carlomagno", nombreEn: "Coronation of Charlemagne", nombreCa: "Coronació de Carlemany", año: 800, descripcion: "El papa León III lo corona emperador de Occidente en Roma.", descripcionEn: "Pope Leo III crowns him Emperor of the West in Rome.", descripcionCa: "El papa Lleó III el corona emperador d'Occident a Roma.", dificultad: "medio", categoria: "edad-media", nivel: ['eso','bachillerato'] },
  { id: 'medi_05', nombre: "Fundación de la Universidad de Bolonia", nombreEn: "Founding of the University of Bologna", nombreCa: "Fundació de la Universitat de Bolonya", año: 1088, descripcion: "Nace la universidad más antigua de Europa que sigue funcionando hoy.", descripcionEn: "The oldest university in Europe still in operation today is founded.", descripcionCa: "Neix la universitat més antiga d'Europa que encara funciona avui.", dificultad: "difícil", categoria: "edad-media", nivel: ['bachillerato'] },
  { id: 'medi_06', nombre: "Primera Cruzada", nombreEn: "First Crusade", nombreCa: "Primera Croada", año: 1096, descripcion: "El papa Urbano II convoca a los cristianos a liberar Jerusalén.", descripcionEn: "Pope Urban II calls on Christians to liberate Jerusalem.", descripcionCa: "El papa Urbà II convoca els cristians a alliberar Jerusalem.", dificultad: "medio", categoria: "edad-media", nivel: ['eso','bachillerato'] },
  { id: 'medi_07', nombre: "Batalla de las Navas de Tolosa", nombreEn: "Battle of Las Navas de Tolosa", nombreCa: "Batalla de les Navas de Tolosa", año: 1212, descripcion: "Los reinos cristianos derrotan a los almohades. Punto de inflexión de la Reconquista.", descripcionEn: "The Christian kingdoms defeat the Almohads. A turning point in the Reconquista.", descripcionCa: "Els regnes cristians derroten els almohades. Punt d'inflexió de la Reconquesta.", dificultad: "difícil", categoria: "edad-media", nivel: ['bachillerato'] },
  { id: 'medi_08', nombre: "Firma de la Magna Carta", nombreEn: "Signing of the Magna Carta", nombreCa: "Signatura de la Magna Carta", año: 1215, descripcion: "El rey Juan sin Tierra firma la primera carta de derechos de la historia.", descripcionEn: "King John signs the first bill of rights in history.", descripcionCa: "El rei Joan sense Terra signa la primera carta de drets de la història.", dificultad: "medio", categoria: "edad-media", nivel: ['eso','bachillerato'] },
  { id: 'medi_09', nombre: "Empieza la Guerra de los Cien Años", nombreEn: "The Hundred Years' War begins", nombreCa: "Comença la Guerra dels Cent Anys", año: 1337, descripcion: "Inglaterra y Francia inician un conflicto que durará más de un siglo.", descripcionEn: "England and France begin a conflict that will last over a century.", descripcionCa: "Anglaterra i França inicien un conflicte que durarà més d'un segle.", dificultad: "difícil", categoria: "edad-media", nivel: ['bachillerato'] },
  { id: 'medi_10', nombre: "Peste Negra en Europa", nombreEn: "Black Death in Europe", nombreCa: "Pesta Negra a Europa", año: 1347, descripcion: "La pandemia de peste bubónica mata a un tercio de la población europea.", descripcionEn: "The bubonic plague pandemic kills a third of Europe's population.", descripcionCa: "La pandèmia de pesta bubònica mata un terç de la població europea.", dificultad: "fácil", categoria: "edad-media", nivel: ['primaria','eso','bachillerato'] },
  { id: 'medi_11', nombre: "Caída de Constantinopla", nombreEn: "Fall of Constantinople", nombreCa: "Caiguda de Constantinoble", año: 1453, descripcion: "Los otomanos conquistan la capital bizantina. Tradicionalmente, el fin de la Edad Media.", descripcionEn: "The Ottomans conquer the Byzantine capital. Traditionally seen as the end of the Middle Ages.", descripcionCa: "Els otomans conquesten la capital bizantina. Tradicionalment, la fi de l'Edat Mitjana.", dificultad: "fácil", categoria: "edad-media", nivel: ['primaria','eso','bachillerato'] },
  { id: 'medi_12', nombre: "Conquista de Granada", nombreEn: "Conquest of Granada", nombreCa: "Conquesta de Granada", año: 1492, descripcion: "Los Reyes Católicos toman el último reino musulmán de la península. Fin de la Reconquista.", descripcionEn: "The Catholic Monarchs take the last Muslim kingdom on the peninsula. The Reconquista ends.", descripcionCa: "Els Reis Catòlics prenen l'últim regne musulmà de la península. Fi de la Reconquesta.", dificultad: "fácil", categoria: "edad-media", nivel: ['primaria','eso','bachillerato'] },

  // ── EDAD MODERNA ──────────────────────────────────────────────────────────
  { id: 'mod_01', nombre: "Descubrimiento de América", nombreEn: "Discovery of America", nombreCa: "Descobriment d'Amèrica", año: 1492, descripcion: "Cristóbal Colón llega a las Bahamas creyendo que había alcanzado Asia.", descripcionEn: "Christopher Columbus reaches the Bahamas believing he had reached Asia.", descripcionCa: "Cristòfor Colom arriba a les Bahames creient que havia arribat a Àsia.", dificultad: "fácil", categoria: "edad-moderna", nivel: ['primaria','eso','bachillerato'] },
  { id: 'mod_02', nombre: "Reforma protestante", nombreEn: "Protestant Reformation", nombreCa: "Reforma Protestant", año: 1517, descripcion: "Lutero clava sus 95 tesis. Europa se divide entre católicos y protestantes.", descripcionEn: "Luther posts his 95 theses. Europe splits between Catholics and Protestants.", descripcionCa: "Luter clava les seves 95 tesis. Europa es divideix entre catòlics i protestants.", dificultad: "medio", categoria: "edad-moderna", nivel: ['eso','bachillerato'] },
  { id: 'mod_03', nombre: "Conquista del Imperio Azteca", nombreEn: "Conquest of the Aztec Empire", nombreCa: "Conquesta de l'Imperi Azteca", año: 1521, descripcion: "Hernán Cortés toma Tenochtitlán. Cae el imperio azteca.", descripcionEn: "Hernán Cortés takes Tenochtitlan. The Aztec Empire falls.", descripcionCa: "Hernán Cortés pren Tenochtitlan. Cau l'imperi asteca.", dificultad: "medio", categoria: "edad-moderna", nivel: ['eso','bachillerato'] },
  { id: 'mod_04', nombre: "Conquista del Imperio Inca", nombreEn: "Conquest of the Inca Empire", nombreCa: "Conquesta de l'Imperi Inca", año: 1532, descripcion: "Francisco Pizarro captura al emperador Atahualpa en Cajamarca.", descripcionEn: "Francisco Pizarro captures Emperor Atahualpa at Cajamarca.", descripcionCa: "Francisco Pizarro captura l'emperador Atahualpa a Cajamarca.", dificultad: "difícil", categoria: "edad-moderna", nivel: ['bachillerato'] },
  { id: 'mod_05', nombre: "Abdicación de Carlos I", nombreEn: "Abdication of Charles I", nombreCa: "Abdicació de Carles I", año: 1556, descripcion: "El emperador divide sus dominios entre su hijo Felipe y su hermano Fernando.", descripcionEn: "The emperor divides his domains between his son Philip and his brother Ferdinand.", descripcionCa: "L'emperador divideix els seus dominis entre el seu fill Felip i el seu germà Ferran.", dificultad: "difícil", categoria: "edad-moderna", nivel: ['bachillerato'] },
  { id: 'mod_06', nombre: "Batalla de Lepanto", nombreEn: "Battle of Lepanto", nombreCa: "Batalla de Lepant", año: 1571, descripcion: "Una flota cristiana derrota a la armada otomana en el Mediterráneo.", descripcionEn: "A Christian fleet defeats the Ottoman navy in the Mediterranean.", descripcionCa: "Una flota cristiana derrota l'armada otomana a la Mediterrània.", dificultad: "medio", categoria: "edad-moderna", nivel: ['bachillerato'] },
  { id: 'mod_07', nombre: "Derrota de la Armada Invencible", nombreEn: "Defeat of the Spanish Armada", nombreCa: "Derrota de l'Armada Invencible", año: 1588, descripcion: "La flota de Felipe II fracasa en su intento de invadir Inglaterra.", descripcionEn: "Philip II's fleet fails in its attempt to invade England.", descripcionCa: "La flota de Felip II fracassa en el seu intent d'envair Anglaterra.", dificultad: "medio", categoria: "edad-moderna", nivel: ['eso','bachillerato'] },
  { id: 'mod_08', nombre: "Empieza la Guerra de los Treinta Años", nombreEn: "The Thirty Years' War begins", nombreCa: "Comença la Guerra dels Trenta Anys", año: 1618, descripcion: "Un conflicto religioso y político devasta Europa central durante tres décadas.", descripcionEn: "A religious and political conflict devastates central Europe for three decades.", descripcionCa: "Un conflicte religiós i polític devasta l'Europa central durant tres dècades.", dificultad: "difícil", categoria: "edad-moderna", nivel: ['bachillerato'] },
  { id: 'mod_09', nombre: "Paz de Westfalia", nombreEn: "Peace of Westphalia", nombreCa: "Pau de Westfàlia", año: 1648, descripcion: "Termina la Guerra de los Treinta Años. Nace el sistema de estados moderno.", descripcionEn: "The Thirty Years' War ends. The modern state system is born.", descripcionCa: "Acaba la Guerra dels Trenta Anys. Neix el sistema d'estats modern.", dificultad: "difícil", categoria: "edad-moderna", nivel: ['bachillerato'] },
  { id: 'mod_10', nombre: "Revolución Gloriosa inglesa", nombreEn: "Glorious Revolution", nombreCa: "Revolució Anglesa (Gloriosa)", año: 1688, descripcion: "El parlamento inglés limita el poder del rey. Nace la monarquía parlamentaria.", descripcionEn: "The English parliament limits the king's power. Parliamentary monarchy is born.", descripcionCa: "El parlament anglès limita el poder del rei. Neix la monarquia parlamentària.", dificultad: "difícil", categoria: "edad-moderna", nivel: ['bachillerato'] },
  { id: 'mod_11', nombre: "Empieza la Guerra de Sucesión Española", nombreEn: "The War of the Spanish Succession begins", nombreCa: "Comença la Guerra de Successió Espanyola", año: 1701, descripcion: "Las potencias europeas luchan por decidir quién hereda el trono español.", descripcionEn: "European powers fight over who will inherit the Spanish throne.", descripcionCa: "Les potències europees lluiten per decidir qui hereta el tron espanyol.", dificultad: "difícil", categoria: "edad-moderna", nivel: ['bachillerato'] },
  { id: 'mod_12', nombre: "Revolución Francesa", nombreEn: "French Revolution", nombreCa: "Revolució Francesa", año: 1789, descripcion: "El pueblo toma la Bastilla. Tradicionalmente, el fin de la Edad Moderna.", descripcionEn: "The people storm the Bastille. Traditionally seen as the end of the Early Modern period.", descripcionCa: "El poble pren la Bastilla. Tradicionalment, la fi de l'Edat Moderna.", dificultad: "fácil", categoria: "edad-moderna", nivel: ['primaria','eso','bachillerato'] },
]
...
export const EXAMENES_HISTORIA = [
  ...
  },
  {
    ...
    nombreCa: 'Franquisme',
    emoji: '🕊️',
    descripcion: 'De la victoria en la Guerra Civil a la muerte del dictador',
    descripcionCa: 'De la victòria a la Guerra Civil a la mort del dictador',
    niveles: ['eso', 'bachillerato'],
  },
  {
    id: 'prehistoria',
    nombre: 'Prehistoria',
    nombreCa: 'Prehistòria',
    emoji: '🦴',
    descripcion: 'Del fuego a la escritura: los primeros pasos de la humanidad',
    descripcionCa: 'Del foc a l\'escriptura: els primers passos de la humanitat',
    niveles: ['primaria', 'eso', 'bachillerato'],
  },
  {
    id: 'edad-media',
    nombre: 'Edad Media',
    nombreCa: 'Edat Mitjana',
    emoji: '🏰',
    descripcion: 'De la caída de Roma a la conquista de Granada',
    descripcionCa: 'De la caiguda de Roma a la conquesta de Granada',
    niveles: ['primaria', 'eso', 'bachillerato'],
  },
  {
    id: 'edad-moderna',
    nombre: 'Edad Moderna',
    nombreCa: 'Edat Moderna',
    emoji: '⛵',
    descripcion: 'Del descubrimiento de América a la Revolución Francesa',
    descripcionCa: 'Del descobriment d\'Amèrica a la Revolució Francesa',
    niveles: ['primaria', 'eso', 'bachillerato'],
  },
]
