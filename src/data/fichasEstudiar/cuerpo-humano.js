// Ficha SEO de /info/estudiar/cuerpo-humano (por idioma; ca cae a es si falta).
...
export default {
  "es": {
    ...
    "studyPath": "/estudiar/biologia/cuerpo-humano",
    ...
    "beneficios": [
      {
        ...
        "texto": "The route of food: mouth → oesophagus → stomach → small intestine (absorption) → large intestine → rectum. The most tested sequence."
      },
      {
        "titulo": "Arteries vs Veins",
        "texto": "Arteries carry blood away from the heart under pressure (thick wall). Veins return blood to the heart (valves, thinner wall). Capillaries = gas and nutrient exchange."
      },
      {
        "titulo": "Nervous System",
        "texto": "CNS: brain + spinal cord. PNS: all peripheral nerves. Reflex arc: stimulus → sensory neuron → spinal cord → motor neuron → effector (no brain needed)."
      }
    ],
    ...
    "beneficios": [
      {
        ...
        "texto": "El recorregut de l'aliment: boca → esòfag → estómac → intestí prim (absorció) → intestí gros → recte. La seqüència més avaluada als exàmens."
      },
      {
        "titulo": "Artèries vs Venes",
        "texto": "Les artèries surten del cor amb pressió (paret gruixuda). Les venes retornen la sang al cor (vàlvules, paret més prima). Els capil·lars fan l'intercanvi de gasos i nutrients."
      },
      {
        "titulo": "Sistema Nerviós",
        "texto": "SNC: cervell + medul·la espinal. SNP: tots els nervis perifèrics. Arc reflex: estímul → neurona sensorial → medul·la → neurona motora → efector (sense passar pel cervell)."
      }
    ],
