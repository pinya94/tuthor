// Ficha SEO de /info/estudiar/nutricion (por idioma; ca cae a es si falta).
...
export default {
    ...
    "beneficios": [
      {
        ...
        "texto": "Carbohydrates (4 kcal/g): quick energy. Proteins (4 kcal/g): build and repair tissues. Fats (9 kcal/g): reserve energy and hormones. Each has a specific role."
      },
      {
        "titulo": "Vitamins",
        "texto": "Fat-soluble (A, D, E, K): stored in liver and fat tissue — excess can be toxic. Water-soluble (B, C): excess excreted in urine — must be taken regularly."
      },
      {
        "titulo": "Mediterranean Diet",
        "texto": "UNESCO Intangible Cultural Heritage. Rich in fruit, vegetables, pulses, wholegrain cereals, olive oil and fish. Associated with lower cardiovascular risk and longer life expectancy."
      }
    ],
  ...
  "ca": {
    ...
    "beneficios": [
      {
        "titulo": "Macronutrients",
        "texto": "Hidrats de carboni (4 kcal/g): energia ràpida. Proteïnes (4 kcal/g): construir i reparar teixits. Greixos (9 kcal/g): energia de reserva i hormones. Cadascun té un rol específic."
      },
      {
        "titulo": "Vitamines",
        "texto": "Liposolubles (A, D, E, K): s'emmagatzemen al fetge i al greix — l'excés pot ser tòxic. Hidrosolubles (B, C): l'excés s'elimina per l'orina — cal prendre-les regularment."
      },
      {
        "titulo": "Dieta Mediterrània",
        "texto": "Patrimoni Cultural Immaterial de la UNESCO. Rica en fruites, verdures, llegums, cereals integrals, oli d'oliva i peix. S'associa a menor risc cardiovascular i major esperança de vida."
      }
    ],
