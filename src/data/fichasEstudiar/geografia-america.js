// Ficha SEO de /info/estudiar/geografia-america (por idioma; ca cae a es si falta).
    ...
    "beneficios": [
      {
        ...
        "texto": "La diferencia entre Hispanoamérica, Latinoamérica y América Anglosajona. Entender qué idiomas se hablan dónde ayuda a recordar la geografía política."
      },
      {
        "titulo": "Grandes Ríos y Selvas",
        "texto": "El Amazonas (más caudaloso del mundo), el Mississippi-Missouri (EEUU), el Orinoco (Venezuela). Los ríos son pistas frecuentes en el juego geográfico."
      },
      {
        "titulo": "Capitales Difíciles",
        "texto": "Surinam → Paramaribo, Bolivia → Sucre (o La Paz), Trinidad y Tobago → Puerto España. Las capitales menos conocidas son las que más suelen preguntar."
      }
    ],
    ...
    "beneficios": [
      {
        ...
        "texto": "The difference between Hispanic America, Latin America and Anglo-Saxon America. Understanding which languages are spoken where helps to remember political geography."
      },
      {
        "titulo": "Great Rivers and Rainforests",
        "texto": "The Amazon (most voluminous river in the world), the Mississippi-Missouri (USA), the Orinoco (Venezuela). Rivers are frequent clues in the geography game."
      },
      {
        "titulo": "Tricky Capitals",
        "texto": "Suriname → Paramaribo, Bolivia → Sucre (or La Paz), Trinidad and Tobago → Port of Spain. The lesser-known capitals are the ones most often tested."
      }
    ],
    ...
    "beneficios": [
      {
        ...
        "texto": "La diferència entre Hispanoamèrica, Llatinoamèrica i Amèrica anglosaxona. Entendre quins idiomes es parlen on ajuda a recordar la geografia política."
      },
      {
        "titulo": "Grans Rius i Selves",
        "texto": "L'Amazones (el més cabalós del món), el Mississipí-Missouri (EEUU), l'Orinoco (Veneçuela). Els rius són pistes freqüents en el joc geogràfic."
      },
      {
        "titulo": "Capitals Difícils",
        "texto": "Surinam → Paramaribo, Bolívia → Sucre (o La Paz), Trinitat i Tobago → Port d'Espanya. Les capitals menys conegudes són les que més solen preguntar."
      }
    ],
