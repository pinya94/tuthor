// Ficha SEO de /info/estudiar/geografia-asia (por idioma; ca cae a es si falta).
...
export default {
  "es": {
    ...
    "beneficios": [
      {
        "titulo": "Las Grandes Potencias Asiáticas",
        "texto": "China (1.400 millones, capital Pekín/Beijing), India (1.400 millones, capital Nueva Delhi), Japón (Tokio), Indonesia (Yakarta). Los cuatro países más importantes de Asia en geografía escolar."
      },
      {
        "titulo": "Oriente Medio y el Golfo",
        "texto": "Arabia Saudí, Emiratos Árabes, Qatar, Kuwait, Irán, Irak, Israel, Turquía. La región más estratégica del mundo en geopolítica actual."
      },
      {
        "nombre": "Asia Central y Pacífico",
        "texto": "Los cinco \"-stán\" (Kazajistán, Uzbekistán, Turkmenistán, Tayikistán, Kirguistán), Corea del Norte y del Sur, Vietnam, Tailandia, Filipinas."
      }
    ],
  ...
  "en": {
    ...
    "beneficios": [
      {
        "titulo": "The Great Asian Powers",
        "texto": "China (1.4 billion, capital Beijing), India (1.4 billion, capital New Delhi), Japan (Tokyo), Indonesia (Jakarta). The four most important countries in school geography."
      },
      {
        "titulo": "The Middle East and Gulf",
        "texto": "Saudi Arabia, UAE, Qatar, Kuwait, Iran, Iraq, Israel, Turkey. The world's most strategically important region in current geopolitics."
      },
      {
        "titulo": "Central Asia and the Pacific",
        "texto": "The five \"-stan\" countries (Kazakhstan, Uzbekistan, Turkmenistan, Tajikistan, Kyrgyzstan), North and South Korea, Vietnam, Thailand, Philippines."
      }
    ],
  ...
  "ca": {
    ...
    "beneficios": [
      {
        "titulo": "Les Grans Potències Asiàtiques",
        "texto": "Xina (1.400 milions, capital Pequín/Beijing), Índia (1.400 milions, capital Nova Delhi), Japó (Tòquio), Indonèsia (Jakarta). Els quatre països més importants d'Àsia en geografia escolar."
      },
      {
        "titulo": "Orient Mitjà i el Golf",
        "texto": "Aràbia Saudita, Emirats Àrabs Units, Qatar, Kuwait, Iran, Iraq, Israel, Turquia. La regió més estratègica del món en geopolítica actual."
      },
      {
        "titulo": "Àsia Central i Pacífic",
        "texto": "Els cinc \"-stan\" (Kazakhstan, Uzbekistan, Turkmenistan, Tadjikistan, Kirguizstan), Corea del Nord i del Sud, Vietnam, Tailàndia, Filipines."
      }
    ],
