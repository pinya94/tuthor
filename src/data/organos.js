...
export const ORGANOS = [
  ...
  organo('clavicula', 'oseo', 90, 56, 8, '#94a3b8',
  ...
  organo('humero', 'oseo', 112, 110, 10, '#cbd5e1',
  ...
  organo('codo', 'oseo', 128, 128, 7, '#e2e8f0',
  ...
  organo('radio', 'oseo', 132, 141, 6, '#cbd5e1',
  ...
  organo('cubito', 'oseo', 123, 141, 6, '#e2e8f0',
  ...
  organo('muneca', 'oseo', 128, 155, 6, '#e2e8f0',
  ...
  organo('femur', 'oseo', 95, 202, 11, '#cbd5e1',
  ...
  organo('rotula', 'oseo', 95, 233, 7, '#e2e8f0',
  ...
  organo('tibia', 'oseo', 92, 264, 6, '#cbd5e1',
  ...
  organo('perone', 'oseo', 100, 264, 5, '#e2e8f0',
  ...
  organo('tobillo', 'oseo', 94, 295, 6, '#cbd5e1',
