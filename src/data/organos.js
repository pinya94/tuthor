...
export const ORGANOS = [
  organo('cerebro', 'nervioso', 74, 25.5, 13, '#a78bfa',
  ...
  organo('pulmones', 'respiratorio', 74, 68.8, 18, '#60a5fa',
  ...
  organo('corazon', 'circulatorio', 62.2, 88.2, 11, '#f87171',
  ...
  organo('diafragma', 'respiratorio', 74, 108, 13, '#38bdf8',
  ...
  organo('estomago', 'digestivo', 59.2, 120.7, 14, '#fb923c',
  ...
  organo('higado', 'digestivo', 88.8, 120.7, 16, '#c2884d',
  ...
  organo('intestinos', 'digestivo', 74, 153.1, 20, '#fbbf24',
