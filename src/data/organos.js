...
// (viewBox 0 0 200 400, vista frontal). Cubren los 4 sistemas que ya trata
// el examen teórico de Cuerpo Humano (src/data/cuerpoHumano.js): nervioso,
...
export const ORGANOS = [
  organo('cerebro', 'nervioso', 100, 42, '#a78bfa',
  ...
  organo('pulmones', 'respiratorio', 100, 92, '#60a5fa',
  ...
  organo('corazon', 'circulatorio', 86, 124, '#f87171',
  ...
  organo('diafragma', 'respiratorio', 100, 152, '#38bdf8',
  ...
  organo('estomago', 'digestivo', 78, 178, '#fb923c',
  ...
  organo('higado', 'digestivo', 124, 178, '#c2884d',
  ...
  organo('intestinos', 'digestivo', 100, 214, '#fbbf24',
