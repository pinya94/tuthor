...
export const GAMES = [
  ...
  { title: 'Corrige el Texto', titleEn: 'Spot the Mistakes (Spanish)', titleCa: 'Corregeix el Text (castellà)', subtitle: 'Caza todas las faltas del texto antes de que corra el reloj', subtitleEn: 'Catch every mistake in a Spanish text before the clock runs', subtitleCa: 'Caça totes les faltes d\'un text en castellà abans que corri el rellotge', emoji: '🔍', gradient: 'from-amber-500 to-orange-700', ready: true, path: '/juegos/corrige-el-texto' },
