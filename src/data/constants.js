...
export const GAMES = [
  ...
  { title: 'Cadena Alimentaria', titleEn: 'Food Chain', titleCa: 'Cadena Alimentària', subtitle: 'Elige el rol trófico de cada organismo', subtitleEn: 'Pick each organism\'s trophic role', subtitleCa: 'Tria el rol tròfic de cada organisme', emoji: '🌿', gradient: 'from-lime-600 to-green-800', ready: true, path: '/juegos/cadena-alimentaria' },
