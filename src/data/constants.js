...
export const GAMES = [
  ...
  { title: 'Diagnóstico', titleEn: 'Diagnosis', titleCa: 'Diagnòstic', subtitle: 'Descarta candidatos con pistas científicas', subtitleEn: 'Rule out candidates with science clues', subtitleCa: 'Descarta candidats amb pistes científiques', emoji: '🩺', gradient: 'from-cyan-500 to-teal-700', ready: true, path: '/juegos/diagnostico' },
