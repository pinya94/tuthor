...
export const GAMES = [
  ...
  { title: 'Reacción', subtitle: 'Primeros auxilios: ordena y decide ante una emergencia', subtitleEn: 'First aid: order the steps and decide in an emergency', subtitleCa: 'Primers auxilis: ordena i decideix davant una emergència', emoji: '🚑', gradient: 'from-red-500 to-rose-700', ready: true, path: '/juegos/reaccion' },
