...
export const GAMES = [
  ...
  { title: 'Una Vida', titleEn: 'One Life', titleCa: 'Una Vida', subtitle: 'Decisiones con dinero, de niño a jubilado', subtitleEn: 'Money decisions, from kid to retiree', subtitleCa: 'Decisions amb diners, de nen a jubilat', emoji: '⏳', gradient: 'from-amber-500 to-yellow-700', ready: true, path: '/juegos/una-vida' },
