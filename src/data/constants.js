...
export const GAMES = [
  ...
  { title: 'Balanza de Ecuaciones', titleEn: 'Equation Balancer', titleCa: 'Balança d\'Equacions', subtitle: 'Ajusta los coeficientes y equilibra la reacción', subtitleEn: 'Adjust the coefficients and balance the reaction', subtitleCa: 'Ajusta els coeficients i equilibra la reacció', emoji: '⚗️', gradient: 'from-emerald-500 to-teal-700', ready: true, path: '/juegos/balanza-ecuaciones' },
