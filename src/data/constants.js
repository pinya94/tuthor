...
export const GAMES = [
  ...
  { title: 'Pon la Tilde', titleEn: 'Spanish Accents', titleCa: 'Posa l\'Accent', subtitle: 'Busca el golpe de voz y decide si lleva tilde', subtitleEn: 'Find the stress and decide on the accent', subtitleCa: 'Busca el cop de veu i decideix si porta accent', emoji: '✏️', gradient: 'from-rose-500 to-pink-700', ready: true, path: '/juegos/pon-la-tilde' },
  { title: 'Corrige el Texto', titleEn: 'Spot the Mistakes', titleCa: 'Corregeix el Text', subtitle: 'Caza todas las faltas del texto antes de que corra el reloj', subtitleEn: 'Catch every spelling mistake before the clock runs', subtitleCa: 'Caça totes les faltes del text abans que corri el rellotge', emoji: '🔍', gradient: 'from-amber-500 to-orange-700', ready: true, path: '/juegos/corrige-el-texto' },
