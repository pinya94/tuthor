// ── Banco de CASTELLANO de Corrige el Texto ─────────────────────────────────
//
// Las trampas de cada idioma son suyas y no se traducen: en inglés no hay
// tildes ni b/v, y en catalán hay ela geminada y accents oberts y tancats que
// aquí no existen. Por eso hay un fichero por idioma con sus propias familias
// y sus propios textos, y el motor (lib/corrigeTexto.js) es el mismo para los
// tres.
//
// Lo que TODOS los bancos tienen que exportar, porque es lo que el motor
// espera: FAMILIAS, NIVELES y TEXTOS. Hay test que lo comprueba.
