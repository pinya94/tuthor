...
const TODAS = [
  ...
  q('pa-40', 'primaria', EN('What is the past simple of "have"?'),
    O(['haved', 'hadded', 'had', 'has']),
    2, '🤲',
    EN('"Have" is irregular: have → had. It is the same form for every person — I had, she had, they had — which makes it one of the easiest irregulars to use once you know it.')),
  q('pa-41', 'primaria', EN('Why is it "stopped" and not "stoped"?'),
    O(['It is a mistake', 'Short verbs ending in one vowel + one consonant double the consonant', 'All verbs double the last letter', 'Because it is irregular']),
    1, '✋',
    EN('Stop → stopped, plan → planned, shop → shopped. The doubling keeps the vowel short: without it, "stoped" would be read like "hoped". Compare with "wanted", which has two consonants already and does not double.')),
  q('pa-42', 'primaria', EN('What is the past simple of "study"?'),
    O(['studyed', 'studied', 'studyd', 'studed']),
    1, '📖',
    EN('A consonant + y becomes -ied: study → studied, carry → carried, try → tried. But a vowel + y just adds -ed: play → played, enjoy → enjoyed. The letter before the y decides.')),
  q('pa-43', 'primaria', EN('Complete: "I ___ at home yesterday."'),
    O(['was', 'were', 'did', 'am']),
    0, '🏠',
    EN('The verb "be" is the only one with TWO past forms: was for I/he/she/it, were for you/we/they. Every other English verb has just one past form for all persons.')),
  q('pa-44', 'primaria', EN('Complete the negative: "She ___ go to school yesterday."'),
    O(['didn\'t', 'doesn\'t', 'wasn\'t', 'don\'t']),
    0, '🚫',
    EN('Negatives in the past use "didn\'t" for every person, and then the verb goes back to its BASE form: didn\'t go, not "didn\'t went". The auxiliary already carries the past.')),
  q('pa-45', 'primaria', EN('Which sentence is correct?'),
    O(['She didn\'t went home.', 'She didn\'t go home.', 'She didn\'t goes home.', 'She not went home.']),
    1, '🏡',
    EN('Once "did" appears, the main verb loses its past form: didn\'t GO, did you GO. Putting the past twice ("didn\'t went") is the most common past simple mistake there is.')),
  q('pa-46', 'primaria', EN('What is the past simple of "see"?'),
    O(['seed', 'saw', 'seen', 'sawed']),
    1, '👀',
    EN('See → saw → seen. Careful with "seen": that is the participle, used with have ("I have seen"), never on its own. "I seen it" is a very common error in speech but wrong in writing.')),
  q('pa-47', 'primaria', EN('Which sentence uses the past simple correctly?'),
    O(['I go to Rome last year.', 'I went to Rome last year.', 'I have gone to Rome last year.', 'I was go to Rome last year.']),
    1, '✈️',
    EN('"Last year" is a finished time, so the past simple is the tense: I went. The present perfect ("I have gone") cannot go with a finished time expression — that is what separates the two tenses.')),
  q('pa-48', 'primaria', EN('What is the past simple of "make"?'),
    O(['maked', 'made', 'maden', 'making']),
    1, '🔨',
    EN('Make → made. Many of the most-used English verbs are irregular precisely because they are used so much: make, take, come, give, get, know. The rare ones tend to be regular.')),
  q('pa-49', 'primaria', EN('Complete the question: "Where ___ you go last weekend?"'),
    O(['did', 'do', 'was', 'were']),
    0, '🗺️',
    EN('Questions in the past use "did" for every person: Where did you go? What did she say? And, as always with did, the main verb stays in its base form.')),
  q('pa-50', 'primaria', EN('Which of these is a regular past simple?'),
    O(['ate', 'played', 'took', 'wrote']),
    1, '⚽',
    EN('Regular verbs just add -ed: play → played. The other three change completely: eat → ate, take → took, write → wrote. There is no rule for irregulars — the list has to be learned.')),
  q('pa-51', 'primaria', EN('Complete: "They ___ (be) at the cinema last night."'),
    O(['was', 'were', 'did', 'are']),
    1, '🎬',
    EN('"They" is plural, so it takes "were". The split is: I/he/she/it → was, and you/we/they → were. It is worth memorising as two short lists because it comes up constantly.')),
]
