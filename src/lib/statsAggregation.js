...
export const SUBJECT_DEFS = [
  {
    ...
    catIds: ['gce', 'wwii', 'roma', 'usa', 'primaria', 'franquismo', 'prehistoria', 'antigua', 'edad-media', 'edad-moderna', 'revolucion-francesa', 'revolucion-industrial', 'primera-guerra-mundial', 'guerra-fria', 'global'],
    catLabels: {
      ...
      'revolucion-francesa': { es: 'Revolución Francesa y Napoleón', en: 'French Revolution & Napoleon', ca: 'Revolució Francesa i Napoleó' },
      'revolucion-industrial': { es: 'Revolución Industrial', en: 'Industrial Revolution', ca: 'Revolució Industrial' },
